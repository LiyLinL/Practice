...
!(function () {
    function dtmlXMLLoaderObject(t, e, i, n) {
        return (
            (this.xmlDoc = ''),
            (this.async = void 0 === i || i),
            (this.onloadAction = t || null),
    ...
    window.dhtmlx ||
        ...
        (dhtmlx.extend_api = function (t, e, i) {
            ...
            n &&
                ...
                (window[t].prototype = n.prototype),
                i && dhtmlXHeir(window[t].prototype, i));
        }),
        (window.dhtmlxAjax = {
            get: function (t, e) {
        ...
        (dtmlXMLLoaderObject.prototype.waitLoadFunction = function (t) {
            var e = !0;
            return (
                (this.check = function () {
                    if (t && t.onloadAction && (!t.xmlDoc.readyState || 4 == t.xmlDoc.readyState)) {
                        ...
                        (e = !1),
                            ...
                            'function' == typeof t.onloadAction && t.onloadAction(t.mainObject, null, null, null, t),
        ...
        (dtmlXMLLoaderObject.prototype.getXMLTopNode = function (t, e) {
            ...
            if (this.xmlDoc.responseXML) {
                ...
                if (0 === n.length && -1 != t.indexOf(':'))
                    var n = this.xmlDoc.responseXML.getElementsByTagName(t.split(':')[1]);
                i = n[0];
        ...
        (dtmlXMLLoaderObject.prototype.loadXMLString = function (t, e) {
            ...
            e ||
                (this.onloadAction && this.onloadAction(this.mainObject, null, null, null, this),
                this.waitCall && (this.waitCall(), (this.waitCall = null)));
        }),
        (dtmlXMLLoaderObject.prototype.loadXML = function (t, e, i, n) {
            this.rSeed && (t += (-1 != t.indexOf('?') ? '&' : '?') + 'a_dhx_rSeed=' + new Date().valueOf()),
                (this.filePath = t),
                ...
                'string' == typeof e
                    ? this.xmlDoc.open(e, t, this.async)
                    : this.xmlDoc.open(e ? 'POST' : 'GET', t, this.async),
                n
                    ? (this.xmlDoc.setRequestHeader('User-Agent', 'dhtmlxRPC v0.1 (' + navigator.userAgent + ')'),
                      this.xmlDoc.setRequestHeader('Content-type', 'text/xml'))
                    : e && this.xmlDoc.setRequestHeader('Content-type', 'application/x-www-form-urlencoded'),
        ...
        (dhtmlDragAndDropObject.prototype.preCreateDragCopy = function (t) {
            if ((!t && !window.event) || 2 != (t || event).button)
                return window.dhtmlDragAndDrop.waitDrag
                    ? ((window.dhtmlDragAndDrop.waitDrag = 0),
                      (document.body.onmouseup = window.dhtmlDragAndDrop.tempDOMU),
                      (document.body.onmousemove = window.dhtmlDragAndDrop.tempDOMM),
                      !1)
                    : (window.dhtmlDragAndDrop.dragNode && window.dhtmlDragAndDrop.stopDrag(t),
                      ...
                      !(!t || !t.preventDefault) && (t.preventDefault(), !1));
        }),
        (dhtmlDragAndDropObject.prototype.callDrag = function (t) {
            ...
            if (!(new Date().valueOf() - e.downtime < 100)) {
                if (!e.dragNode) {
                    ...
                    if (((e.dragNode = e.dragStartObject._createDragNode(e.dragStartNode, t)), !e.dragNode))
                        return e.stopDrag();
                    (e.dragNode.onselectstart = function () {
                        return !1;
                    }),
                        (e.gldragNode = e.dragNode),
                        document.body.appendChild(e.dragNode),
                        (document.body.onmouseup = e.stopDrag),
                        (e.waitDrag = 0),
                        (e.dragNode.pWindow = window),
                        e.initFrameRoute();
                }
                if (e.dragNode.parentNode != window.document.body && e.gldragNode) {
                    ...
                    if (
                        (i.pWindow &&
                            i.pWindow.dhtmlDragAndDrop.lastLanding &&
                            i.pWindow.dhtmlDragAndDrop.lastLanding.dragLanding._dragOut(
                                i.pWindow.dhtmlDragAndDrop.lastLanding
                            ),
                        _isIE)
                    ) {
                    ...
                    (e.dragNode.pWindow = window),
                        (e.gldragNode.old = e.dragNode),
                        document.body.appendChild(e.dragNode),
                        (n.dhtmlDragAndDrop.dragNode = e.dragNode);
                }
                (e.dragNode.style.left =
                    t.clientX +
                    15 +
                    (e.fx ? -1 * e.fx : 0) +
                    (document.body.scrollLeft || document.documentElement.scrollLeft) +
                    'px'),
                    (e.dragNode.style.top =
                        t.clientY +
                        3 +
                        (e.fy ? -1 * e.fy : 0) +
        ...
        (dhtmlDragAndDropObject.prototype.checkLanding = function (t, e) {
            t && t.dragLanding
                ...
                : t && 'BODY' != t.tagName
                ? this.checkLanding(t.parentNode, e)
                : (this.lastLanding && this.lastLanding.dragLanding._dragOut(this.lastLanding, e.clientX, e.clientY, e),
                  (this.lastLanding = 0),
        ...
        (dhtmlDragAndDropObject.prototype.stopDrag = function (t, e) {
            ...
            if (!e) {
                ...
                (i.lastLanding = null),
                    n &&
                        n.dragLanding._drag(i.dragStartNode, i.dragStartObject, n, _isIE ? event.srcElement : t.target);
            }
            (i.lastLanding = null),
        ...
        (dhtmlDragAndDropObject.prototype.stopFrameRoute = function (t) {
            ...
            for (var e = 0; e < window.frames.length; e++)
                try {
                    window.frames[e] != t &&
                        window.frames[e].dhtmlDragAndDrop &&
                        window.frames[e].dhtmlDragAndDrop.stopFrameRoute(window);
                } catch (t) {}
            try {
        ...
        (dhtmlDragAndDropObject.prototype.initFrameRoute = function (t, e) {
            t &&
                ...
                (window.dhtmlDragAndDrop.dragStartNode = t.dhtmlDragAndDrop.dragStartNode),
                (window.dhtmlDragAndDrop.dragStartObject = t.dhtmlDragAndDrop.dragStartObject),
                (window.dhtmlDragAndDrop.dragNode = t.dhtmlDragAndDrop.dragNode),
                (window.dhtmlDragAndDrop.gldragNode = t.dhtmlDragAndDrop.dragNode),
                (window.document.body.onmouseup = window.dhtmlDragAndDrop.stopDrag),
                (window.waitDrag = 0),
                !_isIE && e && (!_isFF || _FFrv < 1.8) && window.dhtmlDragAndDrop.calculateFramePosition());
            try {
                parent.dhtmlDragAndDrop &&
                    parent != window &&
                    parent != t &&
            ...
            for (var i = 0; i < window.frames.length; i++)
                try {
                    window.frames[i] != t &&
                        ...
                        window.frames[i].dhtmlDragAndDrop.initFrameRoute(window, !t || e ? 1 : 0);
                } catch (t) {}
        });
    var _isFF = !1,
        _isIE = !1,
    ...
    -1 != navigator.userAgent.indexOf('Macintosh') && (_isMacOS = !0),
        ...
        -1 != navigator.userAgent.indexOf('Safari') || -1 != navigator.userAgent.indexOf('Konqueror')
            ...
            ? ((_isIE = !0),
              (-1 == navigator.appVersion.indexOf('MSIE 8.0') &&
                  -1 == navigator.appVersion.indexOf('MSIE 9.0') &&
                  -1 == navigator.appVersion.indexOf('MSIE 10.0')) ||
        ...
        (dtmlXMLLoaderObject.prototype.doXPath = function (t, e, i, n) {
            ...
            if (_isIE)
                return (
                    ...
                    i && e.setProperty('SelectionNamespaces', "xmlns:xsl='" + i + "'"),
                    'single' == n ? e.selectSingleNode(t) : e.selectNodes(t) || new Array(0)
                );
            var a = e;
            e || (e = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML),
                e || dhtmlxError.throwError('LoadXML', 'Incorrect XML', [e || this.xmlDoc, this.mainObject]),
                -1 != e.nodeName.indexOf('document') ? (a = e) : ((a = e), (e = e.ownerDocument));
        ...
        (_dhtmlxError.prototype.throwError = function (t, e, i) {
            return this.catches[t]
                ? this.catches[t](t, e, i)
                : this.catches.ALL
                ? this.catches.ALL(t, e, i)
                : (window.alert('Error type: ' + arguments[0] + '\nDescription: ' + arguments[1]), null);
        }),
        (window.dhtmlxError = new _dhtmlxError()),
        (dtmlXMLLoaderObject.prototype.doXPathOpera = function (t, e) {
            ...
            if ('.' == i[0]) n = [e];
                ...
                if ('' !== i[0]) return [];
                (n = (this.xmlDoc.responseXML || this.xmlDoc).getElementsByTagName(i[a].replace(/\[[^\]]*\]/g, ''))),
                    a++;
            }
        ...
        (dtmlXMLLoaderObject.prototype._getAllNamedChilds = function (t, e) {
            ...
            for (var n = 0; n < t.length; n++)
                for (var a = 0; a < t[n].childNodes.length; a++)
                    _isKHTML
                        ? t[n].childNodes[a].tagName &&
                          t[n].childNodes[a].tagName.toUpperCase() == e &&
                          (i[i.length] = t[n].childNodes[a])
                        : t[n].childNodes[a].tagName == e && (i[i.length] = t[n].childNodes[a]);
            return i;
        }),
        void 0 === window.dhtmlxEvent &&
            (window.dhtmlxEvent = function (t, e, i) {
        ...
        (dtmlXMLLoaderObject.prototype.setXSLParamValue = function (t, e, i) {
            ...
            var n = this.doXPath(
                "/xsl:stylesheet/xsl:variable[@name='" + t + "']",
                i,
        ...
        (dtmlXMLLoaderObject.prototype.doXSLTransToObject = function (t, e) {
            ...
            if (_isIE) {
                ...
                this.XSLProcessor || ((this.XSLProcessor = new XSLTProcessor()), this.XSLProcessor.importStylesheet(t)),
                    (i = this.XSLProcessor.transformToDocument(e));
            return i;
        }),
        ...
        (window.dhtmlxEventable = function (obj) {
            (obj.attachEvent = function (t, e, i) {
                return (
                    (t = 'ev_' + t.toLowerCase()),
                    this[t] || (this[t] = new this.eventCatcher(i || this)),
                    t + ':' + this[t].addEvent(e)
                );
            }),
        ...
        (function () {
                ...
                setTimeout(function () {
                    if (t.box) {
                        ...
                        i(!1),
                            ...
                            dhtmlx.callEvent('onAfterMessagePopup', [t.box]),
                            (c = t.box = null),
                            n && n(e);
                    }
                }, 1);
                ...
                if (c) {
                    ...
                    if (dhtmlx.message.keyboard) {
                        if (13 == i || 32 == i) {
                            ...
                            scheduler._getClassName(a).indexOf('dhtmlx_popup_button') > -1 && a.click
                                ? a.click()
                                : (t(c, !0), (n = !0));
                        }
                        27 == i && (t(c, !1), (n = !0));
            ...
            function n(t, e, i) {
                return (
                    '<div ' +
                    scheduler._waiAria.messageButtonAttrString(t) +
                    "class='dhtmlx_popup_button dhtmlx_" +
                    (i || t || '').toLowerCase().replace(/ /g, '_') +
                    "_button' result='" +
                    e +
                    "' ><div>" +
                    t +
            ...
            function a(t) {
                ...
                return (
                    ...
                    (e.className = 'dhtmlx-info dhtmlx-' + t.type),
                    (e.onclick = function () {
                        u.hide(t.id), (t = null);
                    }),
                    scheduler._waiAria.messageInfoAttr(e),
                    'bottom' == u.position && u.area.firstChild
                        ? u.area.insertBefore(e, u.area.firstChild)
                        : u.area.appendChild(e),
                    t.expire > 0 &&
                        (u.timers[t.id] = window.setTimeout(function () {
                            u.hide(t.id);
                        }, t.expire)),
                    (u.pull[t.id] = e),
                    (e = null),
            ...
            function r(e, i, a) {
                ...
                var o = '',
                    d = !1;
                if (
                    (e.width && (r.style.width = e.width),
                    e.height && (r.style.height = e.height),
                    e.title &&
                        ((o += '<div class="dhtmlx_popup_title" id="' + s + '">' + e.title + '</div>'), (d = !0)),
                    (o +=
                        '<div class="dhtmlx_popup_text" ' +
                        (d ? '' : ' id="' + s + '" ') +
                        '><span>' +
                        (e.content ? '' : e.text) +
                        '</span></div><div  class="dhtmlx_popup_controls">'),
                    i)
                ) {
                ...
                if (((o += '</div>'), (r.innerHTML = o), e.content)) {
                    ...
                    'string' == typeof u && (u = document.getElementById(u)),
                        ...
                        r.childNodes[e.title ? 1 : 0].appendChild(u);
                }
                return (
            ...
            function s(t, n, a) {
                ...
                var o = Math.abs(
                        Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - s.offsetWidth) / 2)
                    ),
                    d = Math.abs(
                        Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - s.offsetHeight) / 2)
                    );
                return (
                    'top' == t.position ? (s.style.top = '-3px') : (s.style.top = d + 'px'),
                    (s.style.left = o + 'px'),
                    (s.onkeydown = e),
                    dhtmlx.modalbox.focus(s),
                    t.hidden && dhtmlx.modalbox.hide(s),
            ...
            function _(t, e, i) {
                return (
                    'object' != typeof t &&
                        ('function' == typeof e && ((i = e), (e = '')), (t = { text: t, type: e, callback: i })),
                    t
                );
            }
            function h(t, e, i, n) {
                return (
                    'object' != typeof t && (t = { text: t, type: e, expire: i, id: n }),
                    (t.id = t.id || u.uid()),
                    (t.expire = t.expire || u.expire),
                    t
                );
            }
            var c = null;
            ...
            (u.seed = new Date().valueOf()),
                ...
                (u.hide = function (t) {
                    ...
                    e &&
                        ...
                        (e.className += ' hidden'),
                        u.timers[t] && window.clearTimeout(u.timers[t]),
                        delete u.pull[t]);
                });
        })(),
    ...
    (dataProcessor.prototype = {
        setTransactionMode: function (t, e) {
            'object' == typeof t
                ? ((this._tMode = t.mode || this._tMode),
                  void 0 !== t.headers && (this._headers = t.headers),
                  void 0 !== t.payload && (this._payload = t.payload))
                ...
                a && 'updated' == i && (i = a),
                    e
                        ? (this.set_invalid(t, !1),
                          ...
                          this.obj.setUserData(t, this.action_param, i),
                          this._in_progress[t] && (this._in_progress[t] = 'wait'))
                        : this.is_invalid(t) ||
                          (this.updatedRows.splice(n, 1), this.obj.setUserData(t, this.action_param, '')),
        ...
        markRow: function (t, e, i) {
            var n = '',
                a = this.is_invalid(t);
            if (
                (a && ((n = this.styles[a]), (e = !0)),
                this.callEvent('onRowMark', [t, e, i, a]) &&
                    ((n = this.styles[e ? i : 'clear'] + n), this.obj[this._methods[0]](t, n), a && a.details))
            ) {
        ...
        sendData: function (t) {
            if (!this._waitMode || ('tree' != this.obj.mytype && !this.obj._h2)) {
                ...
                if (
                    ((this.messages = []),
                    !this.checkBeforeUpdate(t) && this.callEvent('onValidationError', [t, this.messages]))
                )
                    return !1;
        ...
        serialize: function (t, e) {
            ...
            return (
                i.push('ids=' + this.escape(n.join(','))),
                (scheduler.security_key || dhtmlx.security_key) &&
                    i.push('dhx_security=' + (scheduler.security_key || dhtmlx.security_key)),
                i.join('&')
            );
        },
            ...
            if (t) {
                ...
                var i = this,
                    n = function (n) {
                        var a = [];
                        if (e) a.push(e);
                        else if (t) for (var r in t) a.push(r);
                    ...
                    r =
                        ...
                        (this._user
                            ? a.urlSeparator(this.serverProcessor) +
                ...
                if ('GET' == this._tMode)
                    ...
                    var _ = this.getState(e),
                        ...
                        c = 'post';
                    'inserted' == _
                        ? (d = this.serialize(t, e))
                        : 'deleted' == _
                        ? ((c = 'DELETE'), (h = h + ('/' == h.slice(-1) ? '' : '/') + e))
                        : ((c = 'PUT'), (d = this.serialize(t, e)), (h = h + ('/' == h.slice(-1) ? '' : '/') + e)),
                        (h = this._applyPayload(h)),
                        a.query({ url: h, method: c, headers: this._headers, data: d, callback: n });
                }
                this._waitMode++;
            }
        },
                ...
                if (this._tSend) this._sendData(this._getAllData());
                    ...
                    for (var e = 0; e < this.updatedRows.length; e++)
                        if (!this._in_progress[this.updatedRows[e]]) {
                            ...
                            if (
                                (this._beforeSendData(this._getRowData(this.updatedRows[e]), this.updatedRows[e]),
        ...
        _getAllData: function (t) {
            for (var e = {}, i = !1, n = 0; n < this.updatedRows.length; n++) {
                ...
                if (!this._in_progress[a] && !this.is_invalid(a)) {
                    ...
                    this.callEvent('onBeforeUpdate', [a, this.getState(a), r]) &&
                        ((e[a] = r), (i = !0), (this._in_progress[a] = new Date().valueOf()));
                }
            }
            return i ? e : null;
        },
        setVerificator: function (t, e) {
            this.mandatoryFields[t] =
                e ||
                function (t) {
                    return '' !== t;
                };
        ...
        afterUpdateCallback: function (t, e, i, n) {
            var a = t,
                r = 'error' != i && 'invalid' != i;
            if ((r || this.set_invalid(t, i), this._uActions && this._uActions[i] && !this._uActions[i](n)))
            ...
            switch (i) {
                ...
                case 'deleted':
                    return (
                        this.obj.setUserData(t, this.action_param, 'true_deleted'),
                        this.obj[this._methods[3]](t, e),
                        delete this._in_progress[a],
                        this.callEvent('onAfterUpdate', [t, i, e, n])
                    );
            }
            'wait' != this._in_progress[a]
                ? (r && this.obj.setUserData(t, this.action_param, ''), delete this._in_progress[a])
                : (delete this._in_progress[a], this.setUpdated(e, !0, this.obj.getUserData(t, this.action_param))),
                this.callEvent('onAfterUpdate', [s, i, e, n]);
        },
        _errorResponse: function (t, e) {
            return (
                this.obj && this.obj.callEvent && this.obj.callEvent('onSaveError', [e, t.xmlDoc]), this.cleanUpdate(e)
            );
        },
        ...
        loadUpdate: function () {
            var t = this.obj.$ajax,
                ...
                n =
                    ...
                    ['dhx_user=' + this._user, 'dhx_version=' + i].join('&');
            (n = n.replace('editing=true&', '')),
                this.getUpdates(n, function (i) {
        ...
        window.dataProcessor &&
            ...
            (dataProcessor.prototype.init = function (t) {
                this.init_original(t),
    ...
    (Scheduler.plugin = function (t) {
        ...
        (Scheduler.getSchedulerInstance = function () {
            ...
            function r(t) {
                return !!(
                    t.querySelector('.dhx_cal_header') &&
                    t.querySelector('.dhx_cal_data') &&
                    t.querySelector('.dhx_cal_navline')
                );
            }
            function s(t) {
            ...
            function d(t) {
                return (
                    t &&
                    'object' == typeof t &&
                    'function String() { [native code] }' === Function.prototype.toString.call(t.constructor)
                );
            }
            function l(t) {
                return (
                    t &&
                    'object' == typeof t &&
                    'function Number() { [native code] }' === Function.prototype.toString.call(t.constructor)
                );
            }
            function _(t) {
                return (
                    t &&
                    'object' == typeof t &&
                    'function Boolean() { [native code] }' === Function.prototype.toString.call(t.constructor)
                );
            }
            function h(t) {
            ...
            function c() {
                if (void 0 === A) {
                    ...
                    (t.style.position = 'absolute'),
                        ...
                        (t.style.top = '-9999px'),
                        (t.innerHTML =
                            "<div class='dhx_cal_container'><div class='dhx_cal_scale_placeholder'></div><div>"),
            ...
            function u() {
                ...
                (t.style.position = 'absolute'),
                    ...
                    (t.style.top = '-9999px'),
                    (t.innerHTML =
                        "<div class='dhx_cal_container'><div class='dhx_cal_data'><div class='dhx_cal_event'><div class='dhx_body'></div></div><div>"),
                    document.body.appendChild(t);
            ...
            var g = { version: '5.3.10' },
                ...
                m = {
                    ...
                    timeline:
                        'ext/dhtmlxscheduler_timeline.js, ext/dhtmlxscheduler_treetimeline.js, ext/dhtmlxscheduler_daytimeline.js',
            ...
            (g._commonErrorMessages = {
                ...
                (g.createTimelineView = function () {
                    throw new Error(
                        'scheduler.createTimelineView is not implemented. Be sure to add the required extension: ' +
                            m.timeline +
                            '\nRelated docs: ' +
                            v.timeline
                    );
                ...
                (g.createUnitsView = function () {
                    throw new Error(
                        'scheduler.createUnitsView is not implemented. Be sure to add the required extension: ' +
                            m.unit +
                            '\nRelated docs: ' +
                            v.unit
                    );
                ...
                (g.createGridView = function () {
                    throw new Error(
                        'scheduler.createGridView is not implemented. Be sure to add the required extension: ' +
                            m.grid +
                            '\nRelated docs: ' +
                            v.grid
                    );
                ...
                (g.addMarkedTimespan = function () {
                    throw new Error(
                        'scheduler.addMarkedTimespan is not implemented. Be sure to add the required extension: ext/dhtmlxscheduler_limit.js\nRelated docs: https://docs.dhtmlx.com/scheduler/limits.html'
                    );
                }),
                (g.renderCalendar = function () {
                    throw new Error(
                        'scheduler.renderCalendar is not implemented. Be sure to add the required extension: ext/dhtmlxscheduler_minical.js\nhttps://docs.dhtmlx.com/scheduler/minicalendar.html'
                    );
                }),
            ...
            var p = {
                ...
                view: function (e) {
                    var i = t('dhx_cal_tab');
                    return (
                        i.setAttribute('name', e.view + '_tab'),
                        i.setAttribute('data-viewname', e.view),
                        g.config.fix_tab_position &&
                            (e.$firstTab
                                ? i.classList.add('dhx_cal_tab_first')
                                : e.$lastTab
                                ? i.classList.add('dhx_cal_tab_last')
                                : 'week' !== e.view && i.classList.add('dhx_cal_tab_standalone')),
                        i
                    );
                },
                date: function () {
            ...
            g._init_nav_bar = function (t) {
                ...
                return (
                    ...
                    (e.className = 'dhx_cal_navline dhx_cal_navline_flex'),
                    g._update_nav_bar(t, e),
                    e)
                );
            };
            var x = null,
            ...
            (g._update_nav_bar = function (t, e) {
                if (t) {
                    ...
                    (null !== b && b === r) || (i = !0),
                        (x && JSON.stringify(t) === x) || (n = !0),
                        i && (g.xy.nav_height = r),
                        n && ((e.innerHTML = ''), e.appendChild(a(t))),
                        (i || n) && ((g._els = []), g.get_elements(), g.set_actions()),
                        (e.style.display = 0 === r ? 'none' : ''),
                        (b = r);
                }
            }),
                ...
                (g._init_once = function () {
                            ...
                            clearTimeout(r),
                                (r = setTimeout(function () {
                                    if (t(n.$container)) {
                                        ...
                                        i(s, r) ||
                                            ((s = r),
                                            n.callEvent('onSchedulerResize', []) &&
                                                (n.updateView(), n.callEvent('onAfterSchedulerResize', [])));
                                    }
                                }, 150));
                        });
                    }
                    function a(t) {
                        ...
                        (i.className = 'scheduler_container_resize_watcher'),
                            (i.tabIndex = -1),
                            t.config.wai_aria_attributes &&
                                (i.setAttribute('role', 'none'), i.setAttribute('aria-hidden', !0)),
                            e.appendChild(i),
            ...
            (g.init = function (t, e, i) {
                if (
                    ...
                    !this.$container.offsetHeight &&
                        ...
                        '100%' === this.$container.style.height &&
                        window.console.error(g._commonErrorMessages.collapsedContainer(), this.$container),
                    this.config.wai_aria_attributes &&
                        this.config.wai_aria_application_role &&
                        this.$container.setAttribute('role', 'application'),
                    this.config.header ||
                        r(this.$container) ||
                        ((this.config.header = s(this)),
                        console.log(
                            [
                    ...
                    (this.$container.innerHTML = ''),
                        ...
                        this.$container.appendChild(y.navbar.render(this.config.header)),
                        this.$container.appendChild(y.header.render()),
                        this.$container.appendChild(y.dataArea.render());
                else if (!r(this.$container))
                    throw new Error(
                        [
                ...
                this.config.rtl && (this.$container.className += ' dhx_cal_container_rtl'),
                    ...
                    this.set_sizes(),
                    g.callEvent('onSchedulerReady', []),
                    this.setCurrentView(e, i);
            }),
                (g.xy = {
                    min_event_height: 40,
                    scale_width: 50,
                ...
                (g.keys = { edit_save: 13, edit_cancel: 27 }),
                (g.bind = function (t, e) {
                    return t.bind
                        ? t.bind(e)
                        : function () {
                ...
                (g.set_sizes = function () {
                    ...
                    g._is_material_skin()
                        ? (a ||
                              ...
                              (a.className = 'dhx_cal_scale_placeholder'),
                              this.$container.insertBefore(a, this._els.dhx_cal_header[0])),
                          (a.style.display = 'block'),
                          this.set_xy(a, t, this.xy.scale_height + 1, 0, this.xy.nav_height + (this._quirks ? -1 : 1)))
                        : a && a.parentNode.removeChild(a),
                        this._lightbox &&
                            (g.$container.offsetWidth < 1200 ||
                ...
                (g.set_xy = function (t, e, i, n, a) {
                    var r = 'left';
                    (t.style.width = Math.max(0, e) + 'px'),
                        (t.style.height = Math.max(0, i) + 'px'),
                        arguments.length > 3 &&
                            (this.config.rtl && (r = 'right'), (t.style[r] = n + 'px'), (t.style.top = a + 'px'));
                }),
                (g.get_elements = function () {
                    for (var t = this._obj.getElementsByTagName('DIV'), e = 0; e < t.length; e++) {
                        ...
                        'string' != typeof a && n && !t[e].innerHTML && (a = n.split('_')[0]),
                            a && (this._waiAria.labelAttr(t[e], a), (t[e].innerHTML = a));
                    }
                }),
                ...
                (g.unselect = function (t) {
                    if (!t || t == this._select_id) {
                        ...
                        (this._select_id = null),
                            e && this.getEvent(e) && this.updateEvent(e),
                            this.callEvent('onEventUnselected', [e]);
                    }
                }),
                (g.getState = function () {
                    return {
                ...
                (g._click = {
                    ...
                    dhx_cal_next_button: function (t, e) {
                        var i = 1;
                        g.config.rtl && ((e = -e), (i = -i)),
                            g.setCurrentView(
                                g.date.add(g.date[g._mode + '_start'](new Date(g._date)), e || i, g._mode)
                            );
                    },
                ...
                (g.addEventNow = function (t, e, i) {
                    ...
                    var o = new Date(e);
                    r.valueOf() == o.valueOf() && o.setTime(o.valueOf() + a),
                        (n.start_date = n.start_date || r),
                        (n.end_date = n.end_date || o),
                    ...
                    return (
                        this.callEvent('onEventCreated', [this._drag_id, i]),
                        (this._loading = !1),
                        (this._drag_event = {}),
                        this._on_mouse_up(i),
                        d
                ...
                (g._get_column_index = function (t) {
                    ...
                    if (this._cols) {
                        for (var i = 0, n = 0; i + this._cols[n] < t && n < this._cols.length; )
                            (i += this._cols[n]), n++;
                        if (
                            ((e = n + (this._cols[n] ? (t - i) / this._cols[n] : 0)),
                            this._ignores && e >= this._cols.length)
                        )
                ...
                (g._week_indexes_from_pos = function (t) {
                    if (this._cols) {
                        ...
                        return (
                            (t.x = Math.min(this._cols.length - 1, Math.max(0, Math.ceil(e) - 1))),
                            (t.y =
                                Math.max(
                                    0,
                                    Math.ceil((60 * t.y) / (this.config.time_step * this.config.hour_size_px)) - 1
                                ) +
                ...
                (g._mouse_coords = function (t) {
                    ...
                    (e =
                        this.$env.isIE || (!t.pageX && !t.pageY)
                            ? {
                                  x: t.clientX + (i.scrollLeft || n.scrollLeft || 0) - i.clientLeft,
                                  y: t.clientY + (i.scrollTop || n.scrollTop || 0) - i.clientTop
                              }
                            : { x: t.pageX, y: t.pageY }),
                        this.config.rtl && this._colsS
                            ? ((e.x = this.$container.querySelector('.dhx_cal_data').offsetWidth - e.x),
                              'month' !== this._mode && (e.x -= this.xy.scale_width))
                            : (e.x -=
                                  this.$domHelpers.getAbsoluteLeft(this._obj) +
                    ...
                    if (r) e = r.call(this, e);
                        ...
                        (e.y = Math.ceil(
                            (24 * (Math.max(0, s) + 7 * Math.max(0, o - 1)) * 60) / this.config.time_step
                        )),
                            (g._drag_mode || 'month' == this._mode) &&
                                (e.y =
                                    (24 * (Math.max(0, Math.ceil(s) - 1) + 7 * Math.max(0, o - 1)) * 60) /
                                    this.config.time_step),
                            'move' == this._drag_mode &&
                                g._ignores_detected &&
                                g.config.preserve_length &&
                                ((e._ignores = !0),
                                this._drag_event._event_length ||
                                    (this._drag_event._event_length = this._get_real_event_length(
                                        this._drag_event.start_date,
                                        this._drag_event.end_date,
                                        { x_step: 1, x_unit: 'day' }
                                    ))),
                            (e.x = 0);
                ...
                (g._correct_shift = function (t, e) {
                    return (t -=
                        6e4 *
                        (new Date(g._min_date).getTimezoneOffset() - new Date(t).getTimezoneOffset()) *
                        (e ? -1 : 1));
                }),
                (g._is_pos_changed = function (t, e) {
                    ...
                    var n = 5;
                    return !!(
                        this._drag_pos.has_moved ||
                        !this._drag_pos.timestamp ||
                        e.timestamp - this._drag_pos.timestamp > 100 ||
                        i(t.ev.clientX, e.ev.clientX, n) ||
                        i(t.ev.clientY, e.ev.clientY, n)
                    );
                }),
                (g._correct_drag_start_date = function (t) {
                    ...
                    return (
                        (e._start_correction || e._end_correction) &&
                            (i = 60 * (e.last_hour || 0) - (60 * t.getHours() + t.getMinutes()) || 1),
                        1 * t + (g._get_fictional_event_length(t, i, e) - i)
                    );
                }),
                    ...
                    if (this._drag_mode) {
                        ...
                        if (this._is_pos_changed(this._drag_pos, e)) {
                            ...
                            if (
                                (this._drag_pos &&
                                    !this._drag_pos.has_moved &&
                                    ((a = this._drag_pos), (a.has_moved = !0)),
                                (this._drag_pos = e),
                                ...
                                if (
                                    ...
                                    (this._loading = !0),
                                    (i = this._get_date_from_pos(e).valueOf()),
                                    !this._drag_start)
                                ) {
                                    return this.callEvent('onBeforeEventCreated', [t, this._drag_id])
                                        ? ((this._loading = !1), void (this._drag_start = i))
                                        : void (this._loading = !1);
                                }
                                (n = i), this._drag_start;
                                var r = new Date(this._drag_start),
                                    s = new Date(n);
                                ('day' != this._mode && 'week' != this._mode) ||
                                    r.getHours() != s.getHours() ||
                                    r.getMinutes() != s.getMinutes() ||
                                    (s = new Date(this._drag_start + 1e3)),
                                    (this._drag_id = this.uid()),
                                    this.addEvent(r, s, this.locale.labels.new_event, this._drag_id, e.fields),
                            ...
                            if (
                                (g.matrix && (o = g.matrix[g._mode]),
                                (o = o || { x_step: 1, x_unit: 'day' }),
                                'move' == this._drag_mode)
                            )
                                (i = this._min_date.valueOf() + 6e4 * (e.y * this.config.time_step + 24 * e.x * 60)),
                                    !e.custom && this._table_view && (i += 1e3 * this.date.time_part(l.start_date)),
                                    !this._table_view &&
                                        this._dragEventBody &&
                                        void 0 === this._drag_event._move_event_shift &&
                                        (this._drag_event._move_event_shift = i - l.start_date),
                                    this._drag_event._move_event_shift && (i -= this._drag_event._move_event_shift),
                                    (i = this._correct_shift(i)),
                                    e._ignores && this.config.preserve_length && this._table_view
                                        ? ((i = g._correct_drag_start_date(i)),
                                          (n = g._correct_drag_end_date(i, this._drag_event._event_length)))
                                        : (n = l.end_date.valueOf() - (l.start_date.valueOf() - i));
                            else {
                                if (((i = l.start_date.valueOf()), (n = l.end_date.valueOf()), this._table_view)) {
                                    var _ =
                                        this._min_date.valueOf() +
                                        e.y * this.config.time_step * 6e4 +
                                        (e.custom ? 0 : 864e5);
                                    if ('month' == this._mode)
                                        ...
                                        this.config.preserve_length
                                            ? e.resize_from_start
                                                ? (i = g._correct_drag_start_date(_))
                                                : (n = g._correct_drag_end_date(_, 0))
                                            : e.resize_from_start
                                            ? (i = _)
                                            : (n = _);
                                } else {
                                    ...
                                    var x = e.y * d * 6e4,
                                        ...
                                        y = 6e4 * p.y;
                                    (n = Math.abs(x - y) > Math.abs(b - y) ? c + b : c + x),
                            ...
                            if (
                                'move' == this._drag_mode &&
                                g.config.limit_drag_out &&
                                (+E < +g._min_date || +n > +g._max_date)
                            ) {
                                if (+l.start_date < +g._min_date || +l.end_date > +g._max_date)
                                    (E = new Date(l.start_date)), (n = new Date(l.end_date));
                                else {
                                    var A = n - E;
                                    +E < +g._min_date
                                        ? ((E = new Date(g._min_date)),
                                          e._ignores && this.config.preserve_length && this._table_view
                                              ? ((E = new Date(g._correct_drag_start_date(E))),
                                                o._start_correction &&
                                                    (E = new Date(E.valueOf() + o._start_correction)),
                                                (n = new Date(
                                                    1 * E +
                                                        this._get_fictional_event_length(
                                                            E,
                                                            this._drag_event._event_length,
                                                            o
                                                        )
                                        ...
                                        : ((n = new Date(g._max_date)),
                                          e._ignores && this.config.preserve_length && this._table_view
                                              ? (o._end_correction && (n = new Date(n.valueOf() - o._end_correction)),
                                                (n = new Date(1 * n - this._get_fictional_event_length(n, 0, o, !0))),
                                                (E = new Date(
                                                    1 * n -
                                                        this._get_fictional_event_length(
                                                            n,
                                                ...
                                                this._ignores_detected &&
                                                    ...
                                                    (n = new Date(
                                                        1 * n - this._get_fictional_event_length(n, 0, o, !0)
                                                    )),
                                                    (n = g.date.add(n, o.x_step, o.x_unit))))
                                              : (E = new Date(+n - A)));
                                }
                                var D = new Date(n - 1);
                            }
                            if (
                                ...
                                !g.config.all_timed &&
                                ((!g._get_section_view() &&
                                    e.x != this._get_event_sday({ start_date: new Date(i), end_date: new Date(i) })) ||
                                ...
                                if ('move' == this._drag_mode) {
                                    ...
                                    (E = new Date(h)),
                                        E.setHours(this.config.first_hour),
                                        (n = new Date(E.valueOf() + A)),
                                        (D = new Date(n - 1));
                                }
                            }
                            if (
                                ...
                                !g.config.all_timed &&
                                ((!g.getView() &&
                                    e.x != this._get_event_sday({ start_date: new Date(n), end_date: new Date(n) })) ||
                                    new Date(n).getHours() >= this.config.last_hour)
                            ) {
                                var A = n - E,
                                    h = this._min_date.valueOf() + 24 * e.x * 60 * 6e4;
                                (n = g.date.date_part(new Date(h))),
                                    n.setHours(this.config.last_hour),
                                    (D = new Date(n - 1)),
                                    'move' == this._drag_mode && (E = new Date(+n - A));
                            }
                            if (
                                this._table_view ||
                                (D.getDate() == E.getDate() && D.getHours() < this.config.last_hour) ||
                                g._allow_dnd
                            )
                            ...
                            this._table_view &&
                                this.for_rendered(this._drag_id, function (t) {
                ...
                (g._on_mouse_down = function (t, e) {
                    if (2 != t.button && !this.config.readonly && !this._drag_mode) {
                        ...
                        var i = g._getClassName(e).split(' ')[0];
                        switch (
                            (this.config.drag_event_body &&
                                'dhx_body' == i &&
                                e.parentNode &&
                                -1 === e.parentNode.className.indexOf('dhx_cal_select_menu') &&
                                ((i = 'dhx_event_move'), (this._dragEventBody = !0)),
                            i)
                        ) {
                            case 'dhx_cal_event_line':
                            case 'dhx_cal_event_clear':
                            ...
                            case 'dhx_event_resize':
                                ...
                                g._getClassName(e).indexOf('dhx_event_resize_end') < 0
                                    ? (g._drag_from_start = !0)
                                    : (g._drag_from_start = !1);
                                break;
                            case 'dhx_scale_holder':
                            case 'dhx_scale_holder_now':
                            case 'dhx_month_body':
                            ...
                            default:
                                if (
                                    (!g.checkEvent('onMouseDown') || g.callEvent('onMouseDown', [i, t])) &&
                                    e.parentNode &&
                                    e != this &&
                                    'dhx_body' != i
                                )
                                    return g._on_mouse_down(t, e.parentNode);
                                (this._drag_mode = null), (this._drag_id = null);
                        }
                        if (this._drag_mode) {
                            var n = this._locate_event(e);
                            if (
                                this.config['drag_' + this._drag_mode] &&
                                this.callEvent('onBeforeDrag', [n, this._drag_mode, t])
                            ) {
                                if (
                                    ((this._drag_id = n),
                                    (this._edit_id != this._drag_id ||
                                        (this._edit_id && 'create' == this._drag_mode)) &&
                                        this._close_not_saved(),
                                    !this._drag_mode)
                                )
                                    return;
                                (this._drag_event = g._lame_clone(this.getEvent(this._drag_id) || {})),
                ...
                (g._on_mouse_up = function (t) {
                    if (!t || 2 != t.button || !this._mobile) {
                        if (this._drag_mode && this._drag_id) {
                            ...
                            if (
                                n &&
                                (this._drag_event._dhx_changed ||
                                    !this._drag_event.start_date ||
                                    a.start_date.valueOf() != this._drag_event.start_date.valueOf() ||
                                    ...
                                    if (((this._drag_id = this._drag_mode = null), r && this.config.edit_on_create)) {
                                        if (
                                            ...
                                            this._table_view ||
                                                ...
                                                !this.config.select ||
                                                !this.isOneDayEvent(this.getEvent(e)))
                                        )
                                            return g.callEvent('onDragEnd', [e, i, t]), this.showLightbox(e);
                                        (this._drag_pos = !0), (this._select_id = this._edit_id = e);
                                    } else
                                        this._new_event ||
                                            this.callEvent(r ? 'onEventAdded' : 'onEventChanged', [
                                                e,
                                                this.getEvent(e)
                                            ]);
                                else
                                    r
                                        ? this.deleteEvent(a.id, !0)
                                        : ((this._drag_event._dhx_changed = !1),
                                          this._clear_temporary_properties(a, this._drag_event),
                                          g._lame_copy(a, this._drag_event),
                                          this.updateEvent(a.id));
                            }
                            this._drag_pos &&
                                (this._drag_pos.has_moved || !0 === this._drag_pos) &&
                                ((this._drag_id = this._drag_mode = null), this.render_view_data()),
                                g.callEvent('onDragEnd', [e, i, t]);
                        }
                ...
                (g.isViewExists = function (t) {
                    return !!(
                        g[t + '_view'] ||
                        (g.date[t + '_start'] && g.templates[t + '_date'] && g.templates[t + '_scale_date'])
                    );
                }),
                (g._set_aria_buttons_attrs = function () {
                    for (
                        var t = ['dhx_cal_next_button', 'dhx_cal_prev_button', 'dhx_cal_tab', 'dhx_cal_today_button'],
                            e = 0;
                        e < t.length;
                        e++
                    )
                        for (var i = this._els[t[e]], n = 0; i && n < i.length; n++) {
                            ...
                            a && (r = this.locale.labels[a] || r),
                                'dhx_cal_next_button' == t[e]
                                    ? (r = this.locale.labels.next)
                                    : 'dhx_cal_prev_button' == t[e] && (r = this.locale.labels.prev),
                                this._waiAria.headerButtonsAttributes(i[n], r || '');
                        }
                }),
                (g.updateView = function (t, e) {
                    ...
                    var i = 'dhx_cal_data',
                        ...
                        r = 'dhx_scheduler_' + e;
                    this._mode && -1 != n.className.indexOf(a)
                        ? (n.className = n.className.replace(a, r))
                        : (n.className += ' ' + r);
                    var s,
                        o = 'dhx_multi_day',
                        d = !(this._mode != e || !this.config.preserve_scroll) && this._els[i][0].scrollTop;
                    this._els[o] && this._els[o][0] && (s = this._els[o][0].scrollTop),
                        this[this._mode + '_view'] && e && this._mode != e && this[this._mode + '_view'](!1),
                        this._close_not_saved(),
                        this._els[o] &&
                            (this._els[o][0].parentNode.removeChild(this._els[o][0]), (this._els[o] = null)),
                        (this._mode = e),
                        (this._date = t),
                    ...
                    if (l)
                        for (var _ = 0; _ < l.length; _++) {
                            var h = l[_];
                            h.getAttribute('name') == this._mode + '_tab'
                                ? (h.classList.add('active'), this._waiAria.headerToggleState(h, !0))
                                : (h.classList.remove('active'), this._waiAria.headerToggleState(h, !1));
                        }
                    'number' == typeof d && (this._els[i][0].scrollTop = d),
                        'number' == typeof s && this._els[o] && this._els[o][0] && (this._els[o][0].scrollTop = s);
                }),
                (g.setCurrentView = function (t, e) {
                    this.callEvent('onBeforeViewChange', [this._mode, this._date, e || this._mode, t || this._date]) &&
                        (this.updateView(t, e), this.callEvent('onViewChange', [this._mode, this._date]));
                }),
                ...
                (g._render_x_header = function (t, e, i, n, a) {
                    ...
                    (r.className = 'dhx_scale_bar'),
                        this.templates[this._mode + '_scalex_class'] &&
                            (r.className += ' ' + this.templates[this._mode + '_scalex_class'](i));
                    var s = this._cols[t] - 1;
                    'month' == this._mode &&
                        0 === t &&
                        this.config.left_border &&
                        ((r.className += ' dhx_scale_bar_border'), (e += 1)),
                        this.set_xy(r, s, this.xy.scale_height - 2, e, a);
                ...
                (g._calc_scale_sizes = function (t, e, i) {
                    ...
                    for (var s = r - this._ignores_detected, o = 0; o < r; o++)
                        this._ignores[o] ? ((this._cols[o] = 0), s++) : (this._cols[o] = Math.floor(a / (s - o))),
                            (a -= this._cols[o]),
                            (this._colsS[o] =
                                (this._cols[o - 1] || 0) +
                                (this._colsS[o - 1] ||
                                    (this._table_view ? 0 : (n ? this.xy.scroll_width : this.xy.scale_width) + 2)));
                ...
                (g._set_scale_col_size = function (t, e, i) {
                    ...
                    this.set_xy(
                        t,
                        e - 1,
                        n.hour_size_px * (n.last_hour - n.first_hour),
                        i + this.xy.scale_width + 1,
                        0
                    );
                }),
                    ...
                    for (var l = 0; l < o; l++) {
                        if ((this._ignores[l] || this._render_x_header(l, d, s, t), !this._table_view)) {
                            ...
                            s.valueOf() == a.valueOf() && (h = 'dhx_scale_holder_now'),
                                _.setAttribute('data-column-index', l),
                                this._ignores_detected && this._ignores[l] && (h += ' dhx_scale_ignore'),
                                (_.className = h + ' ' + this.templates.week_date_class(s, a)),
                                this._waiAria.dayColumnAttr(_, s),
                                this._set_scale_col_size(_, this._cols[l], d),
                                e.appendChild(_),
                                this.callEvent('onScaleAdd', [_, s]);
                        }
                ...
                (g._reset_scale = function () {
                    if (this.templates[this._mode + '_date']) {
                        ...
                        var n =
                            (i.readonly || !i.drag_resize ? ' dhx_resize_denied' : '') +
                            (i.readonly || !i.drag_move ? ' dhx_move_denied' : '');
                        (e.className = 'dhx_cal_data' + n),
                            (this._scales = {}),
                            (this._cols = []),
                        ...
                        if (
                            (l && ((l.innerHTML = d), this._waiAria.navBarDateAttr(l, d)),
                            (this._max_date = o),
                            g._render_scales(t, e),
                            this._table_view)
                        )
                            this._reset_month_scale(e, s, r);
                        else if ((this._reset_hours_scale(e, s, r), i.multi_day)) {
                            var _ = 'dhx_multi_day';
                            this._els[_] &&
                                (this._els[_][0].parentNode.removeChild(this._els[_][0]), (this._els[_] = null));
                            ...
                            (p.className = _ + '_icon'),
                                ...
                                this.set_xy(p, this.xy.scale_width, 0, 0, c),
                                u.appendChild(p),
                                (this._els[_] = [u, p]),
                ...
                (g._reset_hours_scale = function (t, e, i) {
                    ...
                    for (
                        var a = new Date(1980, 1, 1, this.config.first_hour, 0, 0), r = 1 * this.config.first_hour;
                        ...
                        this.config.left_border && (s.className += ' dhx_scale_hour_border'),
                            (s.style.width = o + 'px');
                        var d = g.templates.hour_scale(a);
                        (s.innerHTML = d),
                            this._waiAria.hourScaleAttr(s, d),
                            n.appendChild(s),
                            (a = this.date.add(a, 1, 'hour'));
                    }
                    t.appendChild(n),
                        this.config.scroll_hour &&
                            (t.scrollTop =
                ...
                (g._process_ignores = function (t, e, i, n, a) {
                    ...
                    if (r)
                        for (var s = new Date(t), o = 0; o < e; o++)
                            r(s) && ((this._ignores_detected += 1), (this._ignores[o] = !0), a && e++),
                                (s = g.date.add(s, n, i)),
                                g.date[i + '_start'] && (s = g.date[i + '_start'](s));
                }),
                (g._render_month_scale = function (t, e, i, n) {
                    function a(t) {
                        var e = g._colsS.height;
                        return (
                            void 0 !== g._colsS.heights[t + 1] &&
                                (e = g._colsS.heights[t + 1] - (g._colsS.heights[t] || 0)),
                            e
                        );
                    }
                    ...
                    for (var f = [], l = 0; l < n; l++) {
                        ...
                        for (var m = Math.max(a(l) - g.xy.month_head_height, 0), p = 0; p < 7; p++) {
                            ...
                            i < e
                                ...
                                : i >= r
                                ? (b = 'dhx_after')
                                : i.valueOf() == o.valueOf() && (b = 'dhx_now'),
                                this._ignores_detected && this._ignores[p] && (b += ' dhx_scale_ignore'),
                            ...
                            if (
                                (0 === p &&
                                    this.config.left_border &&
                                    ((y += ' dhx_month_body_border'), (w += ' dhx_month_head_border')),
                                this._ignores_detected && this._ignores[p])
                            )
                ...
                (g._reset_month_scale = function (t, e, i, n) {
                    ...
                    this.date.date_part(r),
                        this.date.date_part(i),
                        (n = n || Math.ceil(Math.round((a.valueOf() - i.valueOf()) / 864e5) / 7));
                    var s = Math.floor(t.clientHeight / n) - this.xy.month_head_height;
                    return (
                        (this._colsS.height = s + this.xy.month_head_height),
                        (this._colsS.heights = []),
                        g._render_month_scale(t, e, i, n)
                    );
                }),
                (g.getView = function (t) {
                    return (
                        t || (t = g.getState().mode),
                        g.matrix && g.matrix[t] ? g.matrix[t] : g._props && g._props[t] ? g._props[t] : null
                    );
                }),
                (g.getLabel = function (t, e) {
                    for (var i = this.config.lightbox.sections, n = 0; n < i.length; n++)
                        if (i[n].map_to == t)
                            for (var a = i[n].options, r = 0; r < a.length; r++) if (a[r].key == e) return a[r].label;
                    return '';
                }),
                ...
                (g._get_date_from_pos = function (t) {
                    var e =
                        this._min_date.valueOf() +
                        6e4 * (t.y * this.config.time_step + 24 * (this._table_view ? 0 : t.x) * 60);
                ...
                (g._get_real_event_length = function (t, e, i) {
                    var n,
                        ...
                        o = 0;
                    i.render
                        ? ((o = this._get_date_index(i, t)), (n = this._get_date_index(i, e)))
                        : (n = Math.round(a / 60 / 60 / 1e3 / 24));
                    for (var d = !0; o < n; ) {
                ...
                (g._get_fictional_event_length = function (t, e, i, n) {
                    ...
                    if (i._start_correction || i._end_correction) {
                        var s;
                        s = n
                            ? 60 * a.getHours() + a.getMinutes() - 60 * (i.first_hour || 0)
                            : 60 * (i.last_hour || 0) - (60 * a.getHours() + a.getMinutes());
                    ...
                    for (
                        i.render
                            ? ((c = this._get_date_index(i, a)), (l = this._get_date_index(i, _)))
                            : (l = Math.round(e / 60 / 60 / 1e3 / 24));
                        c * r <= l * r;
                ...
                (g._get_section_property = function () {
                    return this.matrix && this.matrix[this._mode]
                        ? this.matrix[this._mode].y_property
                        : this._props && this._props[this._mode]
                        ? this._props[this._mode].map_to
                        : null;
                }),
                ...
                (function () {
                    ...
                    g._waiAria = {
                        ...
                        _eventCommonAttr: function (e, i) {
                            i.setAttribute('aria-label', t(g.templates.event_text(e.start_date, e.end_date, e))),
                                g.config.readonly && i.setAttribute('aria-readonly', !0),
                                e.$dataprocessor_class && i.setAttribute('aria-busy', !0),
                                i.setAttribute('aria-selected', g.getState().select_id == e.id ? 'true' : 'false');
                        },
                ...
                (g.$ajax = {
                    ...
                    xmltop: function (t, e, i) {
                        if (void 0 === e.status || e.status < 400) {
                            ...
                            if (n && null !== n.documentElement && !n.getElementsByTagName('parsererror').length)
                                return n.getElementsByTagName(t)[0];
                        }
                        return (
                            -1 !== i && this._obj.callEvent('onLoadXMLError', ['Incorrect XML', arguments[1], i]),
                            document.createElement('DIV')
                        );
                    },
                    xpath: function (t, e) {
                        ...
                        for (
                            var i, n = [], a = (e.ownerDocument || e).evaluate(t, e, null, XPathResult.ANY_TYPE, null);
                            ;
                    ...
                    post: function (t, e, i) {
                        1 == arguments.length
                            ? (e = '')
                            : 2 != arguments.length || ('function' != typeof e && 'function' != typeof window[e])
                            ? (e = String(e))
                            : ((i = e), (e = '')),
                    ...
                    postLong: function (t, e, i) {
                        2 != arguments.length || ('function' != typeof e && (window[e], 0)) || ((i = e), (e = '')),
                            this._call('POST', t, e, !0, i, { url: t, postData: e });
                    },
                    _call: function (t, e, i, n, a, r, s) {
                        var o = this._obj,
                            d =
                                window.XMLHttpRequest && !o.$env.isIE
                                    ? new XMLHttpRequest()
                        ...
                        if (
                                    ...
                                    if (4 == d.readyState || (l && 3 == d.readyState)) {
                                        ...
                                        window.setTimeout(function () {
                                            'function' == typeof a && a.apply(window, [{ xmlDoc: d, filePath: e }]),
                                                r &&
                                                    (void 0 !== r.postData
                                                        ? this.postLong(r.url, r.postData, a)
                                                        : this.getLong(r.url, a)),
                                                (a = null),
                                                (d = null);
                                        }, 1);
                                    }
                            ...
                            'GET' != t ||
                                this.cache ||
                                (e += (e.indexOf('?') >= 0 ? '&' : '?') + 'dhxr' + new Date().getTime() + '=1'),
                            d.open(t, e, n),
                            s)
                        )
                            for (var _ in s) d.setRequestHeader(_, s[_]);
                        else
                            'POST' == t.toUpperCase() || 'PUT' == t || 'DELETE' == t
                                ? d.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded')
                                : 'GET' == t && (i = null);
                        if ((d.setRequestHeader('X-Requested-With', 'XMLHttpRequest'), d.send(i), !n))
                            return { xmlDoc: d, filePath: e };
                    },
            ...
            var E = function (t, e) {
                for (
                    var i = 'var temp=date.match(/[a-zA-Z]+|[0-9]+/g);', n = t.match(/%[a-zA-Z]/g), a = 0;
                    a < n.length;
                    a++
                )
                    switch (n[a]) {
            ...
            (g.date = {
                init: function () {
                    for (
                        var t = g.locale.date.month_short, e = (g.locale.date.month_short_hash = {}), i = 0;
                        i < t.length;
                        i++
                    )
                        e[t[i]] = i;
                    for (
                        var t = g.locale.date.month_full, e = (g.locale.date.month_full_hash = {}), i = 0;
                        i < t.length;
                        i++
                    )
                        e[t[i]] = i;
                ...
                week_start: function (t) {
                    var e = t.getDay();
                    return (
                        g.config.start_on_monday && (0 === e ? (e = 6) : e--),
                        this.date_part(this.add(t, -1 * e, 'day'))
                    );
                },
                ...
                (g.config.buttons_left.$inital = g.config.buttons_left.join()),
                (g.config.buttons_right.$inital = g.config.buttons_right.join()),
                (g._helpers = {
                ...
                (g.templates = {}),
                (g.init_templates = function () {
                    var t = g.locale.labels;
                    (t.dhx_save_btn = t.icon_save),
                    ...
                    (function (t, e) {
                        ...
                        week_date: function (t, e) {
                            return i.rtl
                                ? g.templates.day_date(g.date.add(e, -1, 'day')) + ' &ndash; ' + g.templates.day_date(t)
                                : g.templates.day_date(t) +
                                      ' &ndash; ' +
                                      g.templates.day_date(g.date.add(e, -1, 'day'));
                        },
                        ...
                        tooltip_text: function (t, e, i) {
                            return (
                                ...
                                i.text +
                                '<br/><b>Start date:</b> ' +
                                g.templates.tooltip_date_format(t) +
                                '<br/><b>End date:</b> ' +
                                g.templates.tooltip_date_format(e)
                            );
                        }
                    }),
                ...
                (g.addEvent = function (t, e, i, n, a) {
                    ...
                    var r = t;
                    1 != arguments.length &&
                        ((r = a || {}), (r.start_date = t), (r.end_date = e), (r.text = i), (r.id = n)),
                        (r.id = r.id || g.uid()),
                        (r.text = r.text || ''),
                    ...
                    r.start_date.valueOf() == r.end_date.valueOf() && r.end_date.setTime(r.end_date.valueOf() + s),
                        (r._timed = this.isOneDayEvent(r));
                    var o = !this._events[r.id];
                    return (
                        (this._events[r.id] = r),
                        this.event_updated(r),
                        this._loading || this.callEvent(o ? 'onEventAdded' : 'onEventChanged', [r.id, r]),
                        r.id
                    );
                }),
                (g.deleteEvent = function (t, e) {
                    ...
                    (e ||
                        (this.callEvent('onBeforeEventDelete', [t, i]) &&
                            this.callEvent('onConfirmedBeforeEventDelete', [t, i]))) &&
                        (i &&
                            ((this._select_id = null),
                            ...
                            this._drag_id == i.id &&
                                ((this._drag_id = null), (this._drag_mode = null), (this._drag_pos = null))),
                        this.callEvent('onEventDeleted', [t, i]));
                }),
                ...
                (g.changeEventId = function (t, e) {
                    if (t != e) {
                        var i = this._events[t];
                        i && ((i.id = e), (this._events[e] = i), delete this._events[t]),
                            this.for_rendered(t, function (t) {
                                t.setAttribute('event_id', e);
                            }),
                            this._select_id == t && (this._select_id = e),
                            this._edit_id == t && (this._edit_id = e),
                            this.callEvent('onEventIdChange', [t, e]);
                    }
                }),
                (function () {
                    for (
                ...
                (g.is_visible_events = function (t) {
                    if (
                        t.start_date.valueOf() < this._max_date.valueOf() &&
                        this._min_date.valueOf() < t.end_date.valueOf()
                    ) {
                        ...
                        return (
                            !(!this._table_view && (i > n || i < a) && (e >= n || e < a)) ||
                            !!(
                                (t.end_date.valueOf() - t.start_date.valueOf()) / 36e5 >
                                    24 - (this.config.last_hour - this.config.first_hour) ||
                                (e < n && i >= a)
                            )
                        );
                    }
                ...
                (g.isOneDayEvent = function (t) {
                    ...
                    return (
                        ...
                        t.start_date.getMonth() === e.getMonth() &&
                        t.start_date.getDate() === e.getDate() &&
                ...
                (g.get_visible_events = function (t) {
                    ...
                    for (var i in this._events)
                        this.is_visible_events(this._events[i]) &&
                            ((t && !this._events[i]._timed) ||
                                (this.filter_event(i, this._events[i]) && e.push(this._events[i])));
                    return e;
                }),
                ...
                (g.render_view_data = function (t, e) {
                    ...
                    if (this.config.multi_day && !this._table_view) {
                        ...
                        (this._rendered_location = this._els.dhx_multi_day[0]),
                            (this._table_view = !0),
                            this.render_data(s, e),
                            (this._table_view = !1),
                            (this._rendered_location = this._els.dhx_cal_data[0]),
                            (this._table_view = !1),
                            this.render_data(r, e);
                    } else {
                        var d = document.createDocumentFragment(),
                            l = this._els.dhx_cal_data[0];
                        (this._rendered_location = d),
                            this.render_data(t, e),
                            l.appendChild(d),
                            (this._rendered_location = l);
                    }
                ...
                (g._render_month_link = function (t) {
                    for (var e = this._rendered_location, i = this._lame_clone(t), n = t._sday; n < t._eday; n++) {
                        ...
                        (l.onclick = function (t) {
                            ...
                            (l.className = 'dhx_month_link'),
                            (l.style.top = o.y + 'px'),
                            (l.style.left = o.x + 'px'),
                            (l.style.width = d + 'px'),
                            (l.innerHTML = g.templates.month_events_link(r, s)),
                            this._rendered.push(l),
                            e.appendChild(l);
                    }
                }),
                ...
                g.attachEvent('onEventChanged', g._recalculate_timed),
                g.attachEvent('onEventAdded', g._recalculate_timed),
                (g.render_data = function (t, e) {
                    ...
                    for (var i = {}, n = 0; n < t.length; n++)
                        if (this._table_view)
                            if ('month' != g._mode) this.render_event_bar(t[n]);
                                ...
                                a !== 1 * a || t[n]._sorder < a
                                    ? this.render_event_bar(t[n])
                                    : void 0 !== a && t[n]._sorder == a && g._render_month_link(t[n]);
                            }
                        else {
                            var r = t[n],
                ...
                (g._pre_render_events = function (t, e) {
                    ...
                    if (
                        ((t = this._table_view
                            ? this._pre_render_events_table(t, e)
                            : this._pre_render_events_line(t, e)),
                        this._table_view)
                    )
                            ...
                            if (s.rows) {
                                for (var o = 0; o < s.rows.length; o++) {
                                    ...
                                    if (a[o] * i > l) {
                                        ...
                                        a[o] <= this.config.max_month_events
                                            ? (_ = a[o] * i)
                                            : (this.config.max_month_events + 1) * i > l &&
                                              (_ = (this.config.max_month_events + 1) * i);
                                ...
                                if (
                                    (a.unshift(0),
                                    s.parentNode.offsetHeight < s.parentNode.scrollHeight &&
                                        !g._colsS.scroll_fix &&
                                        g.xy.scroll_width)
                                ) {
                                    var c = g._colsS,
                                        u = c[c.col_length],
                                        f = c.heights.slice();
                                    (u -= g.xy.scroll_width || 0),
                                        this._calc_scale_sizes(u, this._min_date, this._max_date),
                                        (g._colsS.heights = f),
                                        this.set_xy(this._els.dhx_cal_header[0], u, this.xy.scale_height),
                                        g._render_scales(this._els.dhx_cal_header[0]),
                                        g._render_month_scale(
                                            this._els.dhx_cal_data[0],
                                            this._get_timeunit_start(),
                                            this._min_date
                                        ),
                                        (c.scroll_fix = !0);
                                }
                            } else if (
                                (t.length || 'visible' != this._els.dhx_multi_day[0].style.visibility || (a[0] = -1),
                                t.length || -1 == a[0])
                            ) {
                                ...
                                this.config.multi_day_height_limit &&
                                    ((m = Math.min(v, this.config.multi_day_height_limit)), (p = m + 'px')),
                                    (r.style.top =
                ...
                (g._get_event_mapped_end_date = function (t) {
                    ...
                    if (this.config.separate_short_events) {
                        ...
                        i < this._min_mapped_duration &&
                            (e = this.date.add(e, this._min_mapped_duration - i, 'minute'));
                    }
                    return e;
                }),
                (g._pre_render_events_line = function (t, e) {
                    t.sort(function (t, e) {
                        return t.start_date.valueOf() == e.start_date.valueOf()
                            ? t.id > e.id
                                ? 1
                                : -1
                    ...
                    for (var a = 0; a < t.length; a++) {
                        ...
                        if (((r._sday = this._get_event_sday(r)), this._ignores[r._sday])) t.splice(a, 1), a--;
                            ...
                            if ((i[r._sday] || (i[r._sday] = []), !e)) {
                                ...
                                _.splice(u, u == _.length ? 0 : 1, r),
                                    _.length > (_.max_count || 0)
                                        ? ((_.max_count = _.length), (r._count = _.length))
                                        : (r._count = r._count ? r._count : 1);
                            }
                            (d < this.config.first_hour || l >= this.config.last_hour) &&
                                (n.push(r),
                                (t[a] = r = this._copy_event(r)),
                                d < this.config.first_hour &&
                                    (r.start_date.setHours(this.config.first_hour), r.start_date.setMinutes(0)),
                                l >= this.config.last_hour &&
                                    (r.end_date.setMinutes(0), r.end_date.setHours(this.config.last_hour)),
                ...
                (g._is_any_multiday_cell_visible = function (t, e, i) {
                    var n = this._cols.length,
                        ...
                        o = new Date(e);
                    for (
                        g.date.day_start(new Date(e)).valueOf() != e.valueOf() &&
                        ((o = g.date.day_start(o)), (o = g.date.add(o, 1, 'day')));
                        r < o;
                ...
                (g._pre_render_events_table = function (t, e) {
                    ...
                    for (
                        ...
                        var h = o[_],
                            c = i || l.start_date,
                            u = l.end_date;
                        c < this._min_date && ((h.first_chunk = !1), (c = this._min_date)),
                            u > this._max_date && ((h.last_chunk = !1), (u = this._max_date));
                        ...
                        if (((l._sday = f % s), !this._ignores[l._sday] || !l._timed)) {
                            ...
                            (l._eday = v % s || s),
                                (l._length = v - f),
                                (l._sweek = Math.floor(
                                    (this._correct_shift(c.valueOf(), 1) - this._min_date.valueOf()) / (864e5 * s)
                                ));
                            if (g._is_any_multiday_cell_visible(c, u, l)) {
                                var m,
                                    p = a[l._sweek];
                                for (m = 0; m < p.length && !(p[m]._eday <= l._sday); m++);
                                if (((l._sorder && e) || (l._sorder = m), l._sday + l._length <= s))
                                    (i = null),
                                        n.push(l),
                                        (p[m] = l),
                                        (r[l._sweek] = p.length - 1),
                                        (l._first_chunk = h.first_chunk),
                                        (l._last_chunk = h.last_chunk);
                                else {
                                    ...
                                    (x.id = l.id),
                                        ...
                                        (x._sweek = l._sweek),
                                        (x._sorder = l._sorder),
                                        (x.end_date = this.date.add(c, x._length, 'day')),
                                        (x._first_chunk = h.first_chunk),
                ...
                (g.updateEvent = function (t) {
                    ...
                    this.clear_event(t),
                        e &&
                            this.is_visible_events(e) &&
                            this.filter_event(t, e) &&
                            (this._table_view || this.config.multi_day || e._timed) &&
                            (this.config.update_render
                                ? this.render_view_data()
                                : 'month' != this.getState().mode || this.getState().drag_id || this.isOneDayEvent(e)
                                ? this.render_view_data([e], !0)
                                : this.render_view_data());
                }),
                ...
                (g._y_from_date = function (t) {
                    ...
                    return (
                        Math.round(
                            ((60 * e * 1e3 - 60 * this.config.first_hour * 60 * 1e3) * this.config.hour_size_px) / 36e5
                        ) %
                        (24 * this.config.hour_size_px)
                    );
                }),
                    ...
                    if (!(t._sday < 0)) {
                        ...
                        if (r) {
                            ...
                            var m = this._render_v_bar(
                                ...
                                d,
                                t._text_style,
                                g.templates.event_header(t.start_date, t.end_date, t),
                                g.templates.event_text(t.start_date, t.end_date, t)
                            );
                            this._waiAria.eventAttr(t, m), this._rendered.push(m), e.appendChild(m);
                            if (
                                ((c = c + parseInt(this.config.rtl ? r.style.right : r.style.left, 10) + a),
                                this._edit_id == t.id)
                            ) {
                                (m.style.zIndex = 1),
                                    (h = Math.max(h - 4, g.xy.editor_width)),
                                    (m = document.createElement('div')),
                                    m.setAttribute('event_id', t.id),
                                    this._waiAria.eventAttr(t, m),
                                    (m.className = 'dhx_cal_event dhx_cal_editor'),
                                    this.config.rtl && c++,
                                    this.set_xy(m, h, d - 20, c, o + (g.xy.event_header_height || 14)),
                                    t.color && (m.style.backgroundColor = t.color);
                                var p = g.templates.event_class(t.start_date, t.end_date, t);
                                p && (m.className += ' ' + p);
                                var x = document.createElement('div');
                                this.set_xy(x, h - 6, d - 26),
                                    ...
                                    this._quirks7 && (this._editor.style.height = d - 12 + 'px'),
                                    (this._editor.onkeydown = function (t) {
                                        if ((t || event).shiftKey) return !0;
                                        var e = (t || event).keyCode;
                                        e == g.keys.edit_save && g.editStop(!0),
                                            e == g.keys.edit_cancel && g.editStop(!1),
                                            (e != g.keys.edit_save && e != g.keys.edit_cancel) ||
                                                (t.preventDefault && t.preventDefault());
                                    }),
                                    (this._editor.onselectstart = function (t) {
                                        return ((t || event).cancelBubble = !0), !0;
                                    }),
                                    g._focus(this._editor, !0),
                            ...
                            if (0 !== this.xy.menu_width && this._select_id == t.id) {
                                ...
                                for (
                                    ...
                                    (b = this._waiAria.eventMenuAttrString(y[A])),
                                        (w +=
                                            ...
                                            E +
                                            "' title='" +
                                            this.locale.labels[y[A]] +
                                            "'" +
                                            b +
                                            '></div>');
                                var k = this._render_v_bar(
                                    t,
                                    c - n + 1,
                                    o,
                                    n,
                                    20 * y.length + 26 - 2,
                                    '',
                                    "<div style='" + D + E + "' class='dhx_menu_head'></div>",
                                    w,
                                    !0
                                );
                                (k.style.left = c - n + 1),
                                    this._els.dhx_cal_data[0].appendChild(k),
                ...
                (g._render_v_bar = function (t, e, i, n, a, r, s, o, d) {
                    var l = document.createElement('div'),
                        ...
                        c = g.getState();
                    c.drag_id == t.id && (h += ' dhx_cal_event_drag'),
                        c.select_id == t.id && (h += ' dhx_cal_event_selected');
                    ...
                    (k += '<div class="dhx_event_move dhx_title" style="' + f + v + '">' + s + '</div>'),
                        (k +=
                            '<div class="dhx_body" style=" width:' +
                            y +
                            'px; height:' +
                            D +
                            'px;' +
                    ...
                    return (
                        (d || !1 === t._drag_resize) && (S = 'dhx_resize_denied ' + S),
                        (k +=
                            '<div class="' +
                            S +
                            '" style=" width:' +
                ...
                (g.locate_holder = function (t) {
                    return 'day' == this._mode
                        ? this._els.dhx_cal_data[0].firstChild
                        : this._els.dhx_cal_data[0].childNodes[t];
                }),
                ...
                (g._get_dnd_order = function (t, e, i) {
                    ...
                    this._drag_event._orig_sorder
                        ? (t = this._drag_event._orig_sorder)
                        : (this._drag_event._orig_sorder = t);
                ...
                (g._get_event_bar_pos = function (t) {
                    var e = this.config.rtl,
                        ...
                        n = i[t._sday],
                        a = i[t._eday];
                    e && ((n = i[i.col_length] - i[t._eday] + i[0]), (a = i[i.col_length] - i[t._sday] + i[0])),
                        a == n && (a = i[t._eday + 1]);
                ...
                (g.render_event_bar = function (t) {
                    ...
                    if (r) {
                        var o =
                                g.config.resize_month_events &&
                                'month' == this._mode &&
                                (!t._timed || g.config.resize_month_timed),
                        ...
                        (t._timed && !o) || ((u = !1), (f = 'dhx_cal_event_line')),
                            l && (f += ' dhx_cal_event_line_start'),
                            _ && (f += ' dhx_cal_event_line_end'),
                            h && (s += "<div class='dhx_event_resize dhx_event_resize_start'></div>"),
                            c && (s += "<div class='dhx_event_resize dhx_event_resize_end'></div>");
                        ...
                        var m = t.color ? 'background:' + t.color + ';' : '',
                            ...
                            b =
                                ...
                                x +
                                "'" +
                                this._waiAria.eventBarAttrString(t) +
                                '>';
                        o && (b += s),
                            'month' == g.getState().mode && (t = g.getEvent(t.id)),
                            t._timed && (b += g.templates.event_bar_date(t.start_date, t.end_date, t)),
                            (b += g.templates.event_bar_text(t.start_date, t.end_date, t) + '</div>'),
                            (b += '</div>'),
                            (d.innerHTML = b),
                ...
                (g.editStop = function (t, e) {
                    if (!e || this._edit_id != e) {
                        ...
                        i &&
                            (t && (i.text = this._editor.value),
                            (this._edit_id = null),
                            (this._editor = null),
                            this.updateEvent(i.id),
                            this._edit_stop_event(i, t));
                    }
                }),
                (g._edit_stop_event = function (t, e) {
                    this._new_event
                        ? (e ? this.callEvent('onEventAdded', [t.id, t]) : t && this.deleteEvent(t.id, !0),
                          (this._new_event = null))
                        : e && this.callEvent('onEventChanged', [t.id, t]);
                }),
                ...
                (g.showEvent = function (t, e) {
                    ...
                    if (
                        ((e = e || g._mode),
                        n &&
                            (!this.checkEvent('onBeforeEventDisplay') ||
                                this.callEvent('onBeforeEventDisplay', [n, e])))
                    ) {
                        ...
                        var s = n.color,
                            o = n.textColor;
                        if (
                            (g.config.highlight_displayed_event &&
                                ((n.color = g.config.displayed_event_color),
                                (n.textColor = g.config.displayed_event_text_color)),
                            g.setCurrentView(new Date(n.start_date), e),
                            (n.color = s),
                            (n.textColor = o),
                            (g.config.scroll_hour = a),
                            (g.config.preserve_scroll = r),
                            g.matrix && g.matrix[e])
                        ) {
                            var d = g.getView(),
                                l = d.y_property,
                            ...
                            if (_) {
                                if (!i) {
                                    ...
                                    Array.isArray(i)
                                        ? (i = i[0])
                                        : 'string' == typeof i &&
                                          g.config.section_delimiter &&
                                          i.indexOf(g.config.section_delimiter) > -1 &&
                                          (i = i.split(g.config.section_delimiter)[0]);
                                }
                                var h = d.posFromSection(i),
                                    c = d.posFromDate(_.start_date),
                                    u = g.$container.querySelector('.dhx_timeline_data_wrapper');
                                (c -= (u.offsetWidth - d.dx) / 2),
                                    (h = h - u.offsetHeight / 2 + d.dy / 2),
                                    d.scrollTo({ left: c, top: h });
                            }
                        }
                ...
                (g._append_drag_marker = function (t) {
                    if (!t.parentNode) {
                        var e = g._els.dhx_cal_data[0],
                            i = e.lastChild,
                            n = g._getClassName(i);
                        n.indexOf('dhx_scale_holder') < 0 && i.previousSibling && (i = i.previousSibling),
                            (n = g._getClassName(i)),
                            i && 0 === n.indexOf('dhx_scale_holder') && i.appendChild(t);
                    }
                }),
                ...
                (g.highlightEventPosition = function (t) {
                    ...
                    (e.className = 'dhx_drag_marker'),
                        i && (e.className += ' ' + i),
                        n && (e.innerHTML = n),
                        this._append_drag_marker(e);
                }),
                (g._loaded = {}),
                (g._load = function (t, e) {
                    function i(t) {
                        g.on_load(t), g.callEvent('onLoadEnd', []);
                    }
                    if ((t = t || this._load_url)) {
                        (t += (-1 == t.indexOf('?') ? '?' : '&') + 'timeshift=' + new Date().getTimezoneOffset()),
                            this.config.prevent_cache && (t += '&uid=' + this.uid());
                        var n;
                ...
                (g._parsers.xml = {
                    ...
                    parse: function (t) {
                        var e;
                        if (
                            (t.xmlDoc.responseXML || (t.xmlDoc.responseXML = g.$ajax.parse(t.xmlDoc.responseText)),
                            (e = g.$ajax.xmltop('data', t.xmlDoc)),
                            'data' != e.tagName)
                        )
                            return null;
                        ...
                        for (var n = g.$ajax.xpath('//coll_options', t.xmlDoc), a = 0; a < n.length; a++) {
                            ...
                            for (var o = g.$ajax.xpath('.//item', n[a]), d = 0; d < o.length; d++) {
                                for (
                                    var l = o[d],
                                        _ = l.attributes,
                                        h = { key: o[d].getAttribute('value'), label: o[d].getAttribute('label') },
                                        c = 0;
                                    c < _.length;
                                    c++
                                ) {
                ...
                (g.json = g._parsers.json = {
                    ...
                    parse: function (t) {
                        ...
                        'string' == typeof t && (t = JSON.parse(t)),
                            (e = '[object Array]' === Object.prototype.toString.call(t) ? t : t ? t.data : []),
                            (e = e || []),
                            t.dhx_security &&
                                (window.dhtmlx && (dhtmlx.security_key = t.dhx_security),
                                (g.security_key = t.dhx_security));
                    ...
                    parse: function (t) {
                        ...
                        if (e.length) {
                            ...
                            for (
                                var i,
                                    n = [],
                                    a = RegExp('(?:' + this.e_start + ')([^\f]*?)(?:' + this.e_end + ')', 'g');
                                null !== (i = a.exec(e));
                    ...
                    parse_param: function (t, e) {
                        ...
                        if (-1 != i) {
                            ...
                            'summary' == n
                                ? (n = 'text')
                                : 'dtstart' == n
                                ? ((n = 'start_date'), (a = this.parse_date(a, 0, 0)))
                                : 'dtend' == n && ((n = 'end_date'), (a = this.parse_date(a, 0, 0))),
                                (e[n] = a);
                        }
                    },
                ...
                (g.on_load = function (t) {
                    ...
                    (i || (t.xmlDoc.status && t.xmlDoc.status >= 400)) &&
                        (this.callEvent('onLoadError', [t.xmlDoc]), (e = [])),
                        this._process_loading(e),
                ...
                (g.load = function (t, e) {
                    'string' == typeof e && ((this._process = e), (e = arguments[2])),
                        (this._load_url = t),
                        (this._after_call = e),
                        this._load(t, this._date);
                }),
                ...
                (g.serverList = function (t, e) {
                    return e
                        ? ((this.serverList[t] = e.slice(0)), this.serverList[t])
                        : ((this.serverList[t] = this.serverList[t] || []), this.serverList[t]);
                }),
                (g._userdata = {}),
                (g._xmlNodeToJSON = function (t) {
                ...
                g.attachEvent('onXLE', function () {
                    ...
                    t &&
                        'object' == typeof t &&
                        (t.parentNode && t.parentNode.removeChild(t), (this.config.show_loading = !0));
                }),
                ...
                (g.form_blocks = {
                    template: {
                        render: function (t) {
                            var e = g._lightbox_controls.defaults.template,
                                i = e ? e.height : 30;
                            return (
                                "<div class='dhx_cal_ltext dhx_cal_template' style='height:" +
                                (t.height || i || 30) +
                                "px;'></div>"
                            );
                        },
                    ...
                    textarea: {
                        render: function (t) {
                            var e = g._lightbox_controls.defaults.textarea,
                                i = e ? e.height : 200;
                            return (
                                "<div class='dhx_cal_ltext' style='height:" +
                                (t.height || i || '130') +
                    ...
                    select: {
                        render: function (t) {
                            for (
                                var e = g._lightbox_controls.defaults.select,
                                    i = e ? e.height : 23,
                                    n = (t.height || i || '23') + 'px',
                                    a =
                                        "<div class='dhx_cal_ltext' style='height:" +
                    ...
                    time: {
                        render: function (t) {
                            ...
                            var e = t.time_format,
                                ...
                                a = 1440,
                                r = 0;
                            g.config.limit_time_select &&
                                ((a = 60 * i.last_hour + 1), (r = 60 * i.first_hour), n.setHours(i.first_hour));
                            for (var s = '', o = 0; o < e.length; o++) {
                                ...
                                switch (d) {
                                    case '%Y':
                                        ...
                                        t.year_range &&
                                            (isNaN(t.year_range)
                                                ? t.year_range.push && ((c = t.year_range[0]), (u = t.year_range[1]))
                                                : (h = t.year_range)),
                                            (h = h || 10);
                                    ...
                                    case '%H:%i':
                                        ...
                                        for (t._time_values = []; v < a; ) {
                                            (_ +=
                                                ...
                                                v +
                                                "'>" +
                                                this.templates.time_picker(n) +
                                                '</option>'),
                                                t._time_values.push(v),
                                                n.setTime(n.valueOf() + 60 * this.config.time_step * 1e3);
                                            v =
                                                24 * (n.getDate() != m ? 1 : 0) * 60 +
                                                60 * n.getHours() +
                                                n.getMinutes();
                                        }
                                }
                        ...
                        set_value: function (t, e, i, n) {
                            function a(t, e, i) {
                                for (
                                    var a = n._time_values,
                                        r = 60 * i.getHours() + i.getMinutes(),
                                        s = r,
                                        o = !1,
                                        d = 0;
                                    d < a.length;
                                ...
                                (t[e + l[0]].value = o ? r : s),
                                    o || s || (t[e + l[0]].selectedIndex = -1),
                                    (t[e + l[1]].value = i.getDate()),
                                    (t[e + l[2]].value = i.getMonth()),
                                    (t[e + l[3]].value = i.getFullYear());
                            }
                            var r,
                                s,
                                o = g.config,
                            ...
                            if (o.full_day) {
                                if (!t._full_day) {
                                    var _ =
                                        "<label class='dhx_fullday'><input type='checkbox' name='full_day' value='true'> " +
                                        g.locale.labels.full_day +
                                        '&nbsp;</label></input>';
                                    g.config.wide_form || (_ = t.previousSibling.innerHTML + _),
                                        (t.previousSibling.innerHTML = _),
                                        (t._full_day = !0);
                                }
                                var h = t.previousSibling.getElementsByTagName('input')[0];
                                (h.checked =
                                    0 === g.date.time_part(i.start_date) && 0 === g.date.time_part(i.end_date)),
                                    (d[l[0]].disabled = h.checked),
                                    (d[l[0] + d.length / 2].disabled = h.checked),
                                    (h.onclick = function () {
                                        if (h.checked) {
                                            var e = {};
                                            g.form_blocks.time.get_value(t, e, n),
                                                (r = g.date.date_part(e.start_date)),
                                                (s = g.date.date_part(e.end_date)),
                                                (+s == +r ||
                                                    (+s >= +r &&
                                                        (0 !== i.end_date.getHours() ||
                                                            0 !== i.end_date.getMinutes()))) &&
                                                    (s = g.date.add(s, 1, 'day'));
                                        } else (r = null), (s = null);
                                        (d[l[0]].disabled = h.checked),
                                            (d[l[0] + d.length / 2].disabled = h.checked),
                                            a(d, 0, r || i.start_date),
                                            a(d, 4, s || i.end_date);
                                    });
                            }
                                ...
                                for (
                                    var c = function () {
                                            (r = new Date(
                                                ...
                                                (s = new Date(r.getTime() + 60 * g.config.event_duration * 1e3)),
                                                a(d, 4, s);
                                        },
                                        u = 0;
                                    u < 4;
                        ...
                        get_value: function (t, e, i) {
                            ...
                            return (
                                e.end_date <= e.start_date &&
                                    (e.end_date = g.date.add(e.start_date, g.config.time_step, 'minute')),
                                { start_date: new Date(e.start_date), end_date: new Date(e.end_date) }
                            );
                        },
                        focus: function (t) {
                ...
                (g._setLbPosition = function (t) {
                    if (t) {
                        ...
                        (t.style.top = e
                            ? Math.round(e + Math.max((n - t.offsetHeight) / 2, 0)) + 'px'
                            : Math.round(Math.max((n - t.offsetHeight) / 2, 0) + 9) + 'px'),
                            document.documentElement.scrollWidth > document.body.offsetWidth
                                ? (t.style.left =
                                      Math.round(i + (document.body.offsetWidth - t.offsetWidth) / 2) + 'px')
                                : (t.style.left = Math.round((document.body.offsetWidth - t.offsetWidth) / 2) + 'px');
                    }
                }),
                (g.showCover = function (t) {
                    t && ((t.style.display = 'block'), this._setLbPosition(t)),
                        g.config.responsive_lightbox &&
                ...
                (g.showLightbox = function (t) {
                    if (t) {
                        ...
                        this.showCover(e),
                            this._fill_lightbox(t, e),
                            this._waiAria.lightboxVisibleAttr(e),
                ...
                (g.hideLightbox = g.hide_lightbox),
                ...
                (g.save_lightbox = function () {
                    ...
                    (this.checkEvent('onEventSave') &&
                        !this.callEvent('onEventSave', [this._lightbox_id, t, this._new_event])) ||
                        (this._empty_lightbox(t), this.hide_lightbox());
                }),
                ...
                (g.endLightbox = function (t, e) {
                    ...
                    i && this._edit_stop_event(i, t),
                        t && g.render_view_data(),
                        this.hideCover(e),
                        ...
                        this._waiAria.lightboxHiddenAttr(e),
                        this.callEvent('onAfterLightbox', []);
                }),
                (g.resetLightbox = function () {
                    g._lightbox && !g._custom_lightbox && g._lightbox.parentNode.removeChild(g._lightbox),
                        (g._lightbox = null);
                }),
                ...
                (g._init_lightbox_events = function () {
                    (this.getLightbox().onclick = function (t) {
                        var e = t ? t.target : event.srcElement;
                        if (
                            (e.className || (e = e.previousSibling),
                            !(e && e.className && g._getClassName(e).indexOf('dhx_btn_set') > -1) ||
                                (e = e.querySelector('[dhx_button]')))
                        ) {
                                ...
                                switch (i) {
                                    ...
                                    default:
                                        if (e.getAttribute('dhx_button')) g.callEvent('onLightboxButton', [i, e, t]);
                                            ...
                                            var a, r, s;
                                            -1 != i.indexOf('dhx_custom_button') &&
                                                (-1 != i.indexOf('dhx_custom_button_')
                                                    ? ((a = e.parentNode.getAttribute('index')),
                                                      (s = e.parentNode.parentNode))
                                                    : ((a = e.getAttribute('index')),
                                                      (s = e.parentNode),
                                                      (e = e.firstChild))),
                                                a &&
                                                    ((r = g.form_blocks[g.config.lightbox.sections[a].type]),
                                                    r.button_click(a, e, s, s.nextSibling));
                                        }
                                }
                        }
                    }),
                        (this.getLightbox().onkeydown = function (t) {
                            ...
                            switch (
                                (n || (n = i.parentNode.querySelector('.dhx_custom_button, .dhx_readonly')),
                                (t || e).keyCode)
                            ) {
                                case 32:
                ...
                (g.setLightboxSize = function () {
                    ...
                    if (t) {
                        ...
                        (e.style.height = '0px'),
                            ...
                            (t.style.height = e.scrollHeight + g.xy.lightbox_additional_height + 'px'),
                            (e.style.height = e.scrollHeight + 'px');
                    }
                }),
                (g._init_dnd_events = function () {
                    g.event(document.body, 'mousemove', g._move_while_dnd),
                        g.event(document.body, 'mouseup', g._finish_dnd),
                        (g._init_dnd_events = function () {});
                }),
                (g._move_while_dnd = function (t) {
                    if (g._dnd_start_lb) {
                        document.dhx_unselectable ||
                        ...
                        (e.style.top = g._lb_start[1] + i[1] - g._dnd_start_lb[1] + 'px'),
                            (e.style.left = g._lb_start[0] + i[0] - g._dnd_start_lb[0] + 'px');
                    }
                }),
                (g._ready_to_dnd = function (t) {
                    var e = g.getLightbox();
                    (g._lb_start = [parseInt(e.style.left, 10), parseInt(e.style.top, 10)]),
                        (g._dnd_start_lb = t && t.target ? [t.pageX, t.pageY] : [event.clientX, event.clientY]);
                }),
                (g._finish_dnd = function () {
                    g._lb_start &&
                        ((g._lb_start = g._dnd_start_lb = !1),
                ...
                (g.getLightbox = function () {
                    if (!this._lightbox) {
                        ...
                        (t.className = 'dhx_cal_light'),
                            g.config.wide_form && (t.className += ' dhx_cal_light_wide'),
                            g.form_blocks.recurring && (t.className += ' dhx_cal_light_rec'),
                            g.config.rtl && (t.className += ' dhx_cal_light_rtl'),
                            g.config.responsive_lightbox && (t.className += ' dhx_cal_light_responsive'),
                            /msie|MSIE 6/.test(navigator.userAgent) && (t.className += ' dhx_ie6'),
                            (t.style.visibility = 'hidden');
                        for (
                            var e = this._lightbox_template, i = this.config.buttons_left, n = '', a = 0;
                            a < i.length;
                            a++
                        )
                            (n = this._waiAria.lightboxButtonAttrString(i[a])),
                                (e +=
                                    '<div ' +
                                    n +
                                    " class='dhx_btn_set dhx_" +
                                    (g.config.rtl ? 'right' : 'left') +
                                    '_btn_set ' +
                                    i[a] +
                        ...
                        (e += '</div>'),
                            (t.innerHTML = e),
                            g.config.drag_lightbox &&
                                ((t.firstChild.onmousedown = g._ready_to_dnd),
                        ...
                        for (var a = 0; a < s.length; a++) {
                            ...
                            if (o) {
                                ...
                                var d = '';
                                if (s[a].button) {
                                    var n = g._waiAria.lightboxSectionButtonAttrString(
                                        this.locale.labels['button_' + s[a].button]
                                    );
                                    d =
                                        '<div ' +
                                        n +
                                        " class='dhx_custom_button' index='" +
                                        a +
                                ...
                                'string' != typeof l && (l = s[a].name),
                                    (e +=
                                        "<div id='" +
                                        s[a].id +
                                        "' class='dhx_cal_lsection'>" +
                                        d +
                                        '<label>' +
                                        l +
                                        '</label></div>' +
                                        o.render.call(this, s[a])),
                                    (e += '</div>');
                            }
                        }
                        ...
                        if (i.id && document.getElementById(i.id)) {
                            for (
                                var n = document.getElementById(i.id),
                                    a = n.querySelector('label'),
                                    r = g._get_lightbox_section_node(i);
                                r && !r.querySelector;
                            ...
                            if (r) {
                                ...
                                o &&
                                    ((i.inputId = o.id || 'input_' + g.uid()),
                                    o.id || (o.id = i.inputId),
                                    a.setAttribute('for', i.inputId),
                                    (s = !1));
                            }
                            if (s) {
                                g.form_blocks[i.type].focus &&
                ...
                (g._lightbox_template =
                    "<div class='dhx_cal_ltitle'><span class='dhx_mark'>&nbsp;</span><span class='dhx_time'></span><span class='dhx_title'></span></div><div class='dhx_cal_larea'></div>"),
                (g._init_touch_events = function () {
                    if (
                        (((this.config.touch &&
                ...
                (g._touch_events = function (t, e, i) {
                    ...
                    function a(t, e, i, n) {
                        ...
                        return (
                            ...
                            s > i &&
                            (!r || s / r > 3) &&
                            (t.pageX > e.pageX ? g._click.dhx_cal_next_button() : g._click.dhx_cal_prev_button(), !0)
                        );
                    }
                    function r(t) {
                        if (!i(t)) {
                            ...
                            return (
                                'create' == e &&
                                    n &&
                                    (g.render_view_data = function () {
                                        for (
                                            var t = g.getState().drag_id,
                                                e = g.getEvent(t),
                                                i = n.y_property,
                                                a = g.getEvents(e.start_date, e.end_date),
                                                r = 0;
                                            r < a.length;
                                            r++
                                        )
                                            a[r][i] != e[i] && (a.splice(r, 1), r--);
                                        (e._sorder = a.length - 1),
                                            (e._count = a.length),
                                            this.render_data([e], g.getState().mode);
                                    }),
                                g._on_mouse_move(t),
                                'create' == e && n && (g.render_view_data = a),
                                t.preventDefault && t.preventDefault(),
                                (t.cancelBubble = !0),
                                !1
                            );
                    ...
                    function s(t) {
                        i(t) ||
                            (g._hide_global_tip(),
                            _ && (g._on_mouse_up(e(t || event)), (g._temp_touch_block = !1)),
                            (g._drag_id = null),
                            (g._drag_mode = null),
                            (g._drag_pos = null),
                            (g._pointerDragId = null),
                            clearTimeout(l),
                            (_ = c = !1),
                            (h = !0));
                    }
                    ...
                    n(document.body, t[0], function (t) {
                            ...
                            if (n) {
                                ...
                                if (((d = e(t)), c))
                                    return d
                                        ? void (
                                              (o.target != d.target ||
                                                  Math.abs(o.pageX - d.pageX) > 5 ||
                                                  Math.abs(o.pageY - d.pageY) > 5) &&
                                              ((h = !0), clearTimeout(l))
                                          )
                                        : void (h = !0);
                            }
                        ...
                        n(this._els.dhx_cal_data[0], 'touchcancel', s),
                        ...
                        n(this._obj, t[1], function (t) {
                            if (
                                (document && document.body && document.body.classList.add('dhx_cal_touch_active'),
                                !i(t))
                            ) {
                                ...
                                if (!h && !_ && a - u < 250)
                                    return (
                                        g._click.dhx_cal_data(n),
                                        window.setTimeout(function () {
                                            (n.type = 'dblclick'), g._on_dbl_click(n);
                                        }, 50),
                                        t.preventDefault && t.preventDefault(),
                                        (t.cancelBubble = !0),
                                        (g._block_next_stop = !0),
                                        !1
                                    );
                                if (((u = a), !h && !_ && g.config.touch_drag)) {
                                    ...
                                    (l = setTimeout(function () {
                                        ...
                                        var t = o.target,
                                            e = g._getClassName(t);
                                        t && -1 != e.indexOf('dhx_body') && (t = t.previousSibling),
                                            g._on_mouse_down(o, t),
                                            g._drag_mode &&
                                                'create' != g._drag_mode &&
                                                g.for_rendered(g._drag_id, function (t, e) {
                                                    (t.style.display = 'none'), g._rendered.splice(e, 1);
                                                }),
                                            g.config.touch_tip && g._show_global_tip(),
                                            g.updateEvent(g._drag_id);
                                    }, g.config.touch_drag)),
                                        (o = n);
                                }
                            }
                        ...
                        n(this._els.dhx_cal_data[0], t[2], function (t) {
                            if (
                                (document && document.body && document.body.classList.remove('dhx_cal_touch_active'),
                                !i(t))
                            )
                                return (
                                    g.config.touch_swipe_dates && !_ && a(o, d, 200, 100) && (g._block_next_stop = !0),
                                    _ &&
                                        ((g._ignore_next_click = !0),
                                        setTimeout(function () {
                                            g._ignore_next_click = !1;
                                        }, 100)),
                                    s(t),
                                    g._block_next_stop
                                        ? ((g._block_next_stop = !1),
                                          t.preventDefault && t.preventDefault(),
                                          (t.cancelBubble = !0),
                                          !1)
                                        : void 0
                        ...
                        if (g._drag_id && !t) {
                            ...
                            n &&
                                (i =
                                    '<div>' +
                                    (n._timed
                                        ? g.templates.event_header(n.start_date, n.end_date, n)
                                        : g.templates.day_date(n.start_date, n.end_date, n)) +
                                    '</div>');
                        }
                        'create' == g._drag_mode || 'new-size' == g._drag_mode
                            ? (e.innerHTML = (g.locale.labels.drag_to_create || 'Drag to create') + i)
                            : (e.innerHTML = (g.locale.labels.drag_to_move || 'Drag to move') + i);
                    }
                }),
                ...
                (g._dp_init = function (t) {
                    (t._methods = ['_set_event_text_style', '', '_dp_change_event_id', '_dp_hook_delete']),
                        (this._dp_change_event_id = function (t, e) {
                        ...
                        (this._dp_hook_delete = function (e, i) {
                            if (g.getEvent(e))
                                return (
                                    i &&
                                        e != i &&
                                        ('true_deleted' == this.getUserData(e, t.action_param) &&
                                            this.setUserData(e, t.action_param, 'updated'),
                                        this.changeEventId(e, i)),
                                    this.deleteEvent(i, !0)
                                );
                        }),
                        ...
                        this.attachEvent('onConfirmedBeforeEventDelete', function (e) {
                            if (this._validId(e)) {
                                var i = t.getState(e);
                                return 'inserted' == i || this._new_event
                                    ? (t.setUpdated(e, !1), !0)
                                    : 'deleted' != i && ('true_deleted' == i || (t.setUpdated(e, !0, 'deleted'), !1));
                            }
                        }),
                    ...
                    var e = function (t, i, n) {
                            ...
                            for (var a in t)
                                0 !== a.indexOf('_') &&
                                    (t[a] && t[a].getUTCFullYear
                                        ? (i[n + a] = this.obj._helpers.formatDate(t[a]))
                                        : t[a] && 'object' == typeof t[a]
                                        ? e.call(this, t[a], i, n + a + '.')
                                        : (i[n + a] = t[a]));
                            return i;
                        },
                        i = function (t) {
                            ...
                            for (var n in e)
                                0 === n.indexOf('_')
                                    ...
                                    : e[n] &&
                                      (e[n].getUTCFullYear
                                          ? (e[n] = this.obj._helpers.formatDate(e[n]))
                                          : 'object' == typeof e[n] && (e[n] = i(e[n])));
                            return e;
                        };
                    (t._getRowData = function (t, n) {
                        ...
                        t.attachEvent('insertCallback', g._update_callback),
                        t.attachEvent('updateCallback', g._update_callback),
                        t.attachEvent('deleteCallback', function (t, e) {
                            this.obj.getEvent(e)
                                ? (this.obj.setUserData(e, this.action_param, 'true_deleted'), this.obj.deleteEvent(e))
                                : this.obj._add_rec_marker && this.obj._update_callback(t, e);
                        });
                }),
                ...
                (g._update_callback = function (t, e) {
                    ...
                    'none' == i.rec_type && (i.rec_pattern = 'none'),
                        (i.text = i.text || i._tagvalue),
                        (i.start_date = g._helpers.parseDate(i.start_date)),
                        (i.end_date = g._helpers.parseDate(i.end_date)),
                        g.addEvent(i),
                        g._add_rec_marker && g.setCurrentView();
                }),
                (g.getRootView = function () {
                    return {
                        view: {
                            ...
                            init: function () {
                                var t = document.createElement('DIV');
                                (t.id = 'scheduler_' + g.uid()),
                                    (t.style.width = '100%'),
                                    (t.style.height = '100%'),
                                    t.classList.add('dhx_cal_container'),
                                    (t.cmp = 'grid'),
                                    (t.innerHTML =
                                        '<div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div><div class="dhx_cal_tab" name="day_tab"></div><div class="dhx_cal_tab" name="week_tab"></div><div class="dhx_cal_tab" name="month_tab"></div></div><div class="dhx_cal_header"></div><div class="dhx_cal_data"></div>'),
                                    g.init(t),
                                    (this.el = t);
                            }
                        },
                ...
                (g._skin_xy = { lightbox_additional_height: [90, 50], nav_height: [59, 22], bar_height: [24, 20] }),
            ...
            window.addEventListener('DOMContentLoaded', f),
                ...
                (g._skin_init = function () {
                    ...
                    if ((!g.skin || ('classic' !== g.skin && 'glossy' !== g.skin) || (n = 1), g._is_material_skin())) {
                        ...
                        if (
                            a &&
                            g.config.buttons_left.slice().join() == a &&
                            r &&
                            g.config.buttons_right.slice().join() == r
                        ) {
                            var s = g.config.buttons_left.slice();
                            (g.config.buttons_left = g.config.buttons_right.slice()), (g.config.buttons_right = s);
                        }
                        (g.xy.event_header_height = 18),
                            (g.xy.week_agenda_scale_height = 35),
                            (g.xy.map_icon_width = 38),
                            (g._lightbox_controls.defaults.textarea.height = 64),
                            (g._lightbox_controls.defaults.time.height = 'auto');
                    }
                    if (
                        (this._configure(g.config, g._skin_settings, n),
                        this._configure(g.xy, g._skin_xy, n),
                        'flat' === g.skin &&
                            ((g.xy.scale_height = 35),
                            (g.templates.hour_scale = function (t) {
                                var e = t.getMinutes();
                                return (
                                    (e = e < 10 ? '0' + e : e),
                                    "<span class='dhx_scale_h'>" +
                                        t.getHours() +
                                        "</span><span class='dhx_scale_m'>&nbsp;" +
                                        e +
                                        '</span>'
                                );
                            })),
                        ...
                        o && (o.padding = 14),
                            (g.templates.event_bar_date = function (t, e, i) {
                            ...
                            g.attachEvent('onTemplatesReady', function () {
                                ...
                                if (
                                    ((g.templates.month_day = function (i) {
                                        if ('month' == this._mode) {
                                            var n = t(i);
                                            return (
                                                1 == i.getDate() &&
                                                    (n = g.locale.date.month_full[i.getMonth()] + ' ' + n),
                                                +i == +g.date.date_part(this._currentDate()) &&
                                                    (n = g.locale.labels.dhx_cal_today_button + ' ' + n),
                                                n
                                            );
                                        }
                                    ...
                                    for (var o = 0; o < i.length; o++) {
                                        ...
                                        if (l) {
                                            switch (((d.style.right = 'auto'), l)) {
                                                ...
                                                default:
                                                    (d.style.left = a + 'px'),
                                                        (d.className += ' dhx_cal_tab_standalone'),
                                                        (a = a + s + d.offsetWidth);
                                            }
                                            d.className += ' ' + l;
                                        } else
                                            0 === (d.className || '').indexOf('dhx_minical_icon') &&
                                                d.parentNode == g._els.dhx_cal_navline[0] &&
                                                (n = d);
                                    }
                                    n && (n.style.left = a + 'px');
                                }
                                    ...
                                    this.each(function () {
                                        if (this && this.getAttribute)
                                            if (this.getAttribute('dhxscheduler'))
                                                ...
                                                e &&
                                                    ((t = 'scheduler' + (e + 1)),
                                                    (window[t] = Scheduler.getSchedulerInstance()));
                                                var i = window[t];
                ...
                (function () {
                        ...
                        r = function (e, r) {
                            ...
                            t(this, e, r),
                                (a = setTimeout(function () {
                                    if (!s.callEvent('onBeforeViewChange', [d, o, r || s._mode, e || s._date]))
                                        return void t(s, o, d);
                                    i.call(s, e, r),
                                        s.callEvent('onViewChange', [s._mode, s._date]),
                    ...
                    g.attachEvent('onSchedulerReady', function () {
                        g.config.delay_render
                            ? ((g.setCurrentView = r), (g.updateView = s))
                            : ((g.setCurrentView = e), (g.updateView = i));
                    });
                })();
        ...
        dhtmlx &&
            dhtmlx.attaches &&
            (dhtmlx.attaches.attachScheduler = function (t, e, i, n) {
                var i =
                        i ||
                    ...
                    a = document.createElement('DIV');
                return (
                    (a.id = 'dhxSchedObj_' + this._genStr(12)),
                    (a.innerHTML =
                        '<div id="' +
                        a.id +
                    ...
                    (this.vs[this.av].sched = n),
                    (this.vs[this.av].schedId = a.id),
                    (n.setSizes = n.updateView),
