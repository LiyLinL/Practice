sap.ui.define(
    ...
    function (jQuery, Fragment, Object, Filter, JSONModel) {
        'use strict';
        return Object.extend('fw.fragment.SelectDialog', {
            /**
            ...
            open: function (oSource, me, myfunction) {
                this.oView = me.oView ? me.oView : me.dialog ? me.dialog : me; //畫面的view
                ...
                if (!this.dialog) {
                    //該彈出框的設定
                    this.dialog = sap.ui.xmlfragment('fw.fragment.SelectDialog', this);
                    jQuery.sap.syncStyleClass('sapUiSizeCompact', this.oView, this.dialog);
                    this.oView.addDependent(this.dialog);
                }
                //設定標題
                var i18n = this.oView.getModel('i18n').getResourceBundle();
                this.dialog.setTitle(i18n.getText('g.select') + i18n.getText(this.handle));
                //設定root和cell
            ...
            searchDialog: function (oEvent) {
                ...
                var filters = [
                    new Filter(this.title, sap.ui.model.FilterOperator.Contains, value),
                    new Filter(this.description, sap.ui.model.FilterOperator.Contains, value)
                ];
                oEvent
                    .getSource()
                    .getBinding('items')
            ...
            confirmDialog: function (oEvent) {
                var input;
                if (this.oView.byId) {
                    input = this.oView.byId(this.inputId);
                }
                if (input == null) {
